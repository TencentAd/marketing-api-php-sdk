 ...
 */
class UpdateDynamicCreatives
{
    public static $tads;
    public static $ACCESS_TOKEN           = 'YOUR ACCESS TOKEN';
    public static $ACCOUNT_ID             = 'YOUR ACCOUNT ID';
    public static $DYNAMIC_CREATIVE_ID    = 'YOUR DYNAMIC CREATIVE ID'; // 要修改的动态创意ID
        ...
        try {
            ...
            $response = $tads->dynamicCreatives()
                             ->update([
                                 ...
                                 'dynamic_creative_id'          => static::$DYNAMIC_CREATIVE_ID,
...
if (basename($_SERVER['PHP_SELF']) == basename(__FILE__)) {
    try {
        $example = new UpdateDynamicCreatives();
        $example->init();
        $example->main();
    } catch (\Exception $e) {
        exit(-1);
