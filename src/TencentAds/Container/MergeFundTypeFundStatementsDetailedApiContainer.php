...
use TencentAds\Api\MergeFundTypeFundStatementsDetailedApi;
...
class MergeFundTypeFundStatementsDetailedApiContainer extends ApiContainer
{
    ...
    public function get(array $params = [])
    {
        return $this->handleMiddleware('get', $params, function(MiddlewareRequest $request) {
            ...
            $response = $this->apiInstance->mergeFundTypeFundStatementsDetailedGet($accountId, $fundType, $dateRange, $page, $pageSize, $fields);
    ...
    public function getAsync(array $params = [])
    {
        return $this->handleMiddleware('get', $params, function(MiddlewareRequest $request) {
            ...
            $pageSize = isset($params['page_size']) ? $params['page_size'] : null;
            $fields = isset($params['fields']) ? $params['fields'] : null;
            $response = $this->apiInstance->mergeFundTypeFundStatementsDetailedGetAsync($accountId, $fundType, $dateRange, $page, $pageSize, $fields);
            return $response;
        });
    }
}
