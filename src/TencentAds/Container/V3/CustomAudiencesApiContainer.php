...
use TencentAds\Api\V3\CustomAudiencesApi;
...
class CustomAudiencesApiContainer extends ApiContainer
{
    ...
    public function get(array $params = [])
    {
        return $this->handleMiddleware('get', $params, function(MiddlewareRequest $request) {
            ...
            $response = $this->apiInstance->customAudiencesGet($accountId, $audienceId, $page, $pageSize, $fields);
            return $this->handleResponse($response);
        });
    }
    ...
    public function getAsync(array $params = [])
    {
        return $this->handleMiddleware('get', $params, function(MiddlewareRequest $request) {
            ...
            $pageSize = isset($params['page_size']) ? $params['page_size'] : null;
            $fields = isset($params['fields']) ? $params['fields'] : null;
            $response = $this->apiInstance->customAudiencesGetAsync($accountId, $audienceId, $page, $pageSize, $fields);
            return $response;
        });
    }
