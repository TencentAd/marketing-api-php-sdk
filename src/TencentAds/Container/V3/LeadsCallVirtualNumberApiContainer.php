...
use TencentAds\Api\V3\LeadsCallVirtualNumberApi;
...
class LeadsCallVirtualNumberApiContainer extends ApiContainer
{
    ...
    public function get(array $params = [])
    {
        return $this->handleMiddleware('get', $params, function(MiddlewareRequest $request) {
            ...
            $response = $this->apiInstance->leadsCallVirtualNumberGet($accountId, $caller, $callee, $leadsId, $outerLeadsId, $requestId, $fields);
    ...
    public function getAsync(array $params = [])
    {
        return $this->handleMiddleware('get', $params, function(MiddlewareRequest $request) {
            ...
            $requestId = isset($params['request_id']) ? $params['request_id'] : null;
            $fields = isset($params['fields']) ? $params['fields'] : null;
            $response = $this->apiInstance->leadsCallVirtualNumberGetAsync($accountId, $caller, $callee, $leadsId, $outerLeadsId, $requestId, $fields);
            return $response;
        });
    }
}
