...
use TencentAds\Api\V3\WalletInvoiceApi;
use TencentAds\Kernel\V3\ApiContainer;
use TencentAds\Kernel\V3\HeaderHandler;
use TencentAds\Middleware\Model\MiddlewareRequest;
use TencentAds\V3\TencentAds;

class WalletInvoiceApiContainer extends ApiContainer
{
    /** @var WalletInvoiceApi */
    public $apiInstance;
    ...
    public function init(TencentAds $app, Client $client)
    {
        ...
        $this->apiInstance = new WalletInvoiceApi($client, $app->getConfig(), new HeaderHandler());
        return $this;
    }


    /**
     * Handle WalletInvoiceApi walletInvoiceGet function
     * @param array params
     * @return mixed
    ...
    public function get(array $params = [])
    {
        return $this->handleMiddleware('get', $params, function(MiddlewareRequest $request) {
            ...
            $walletIdList = isset($params['wallet_id_list']) ? $params['wallet_id_list'] : null;
    ...
    /**
     * Handle WalletInvoiceApi walletInvoiceGetAsync function
     * @param array params
