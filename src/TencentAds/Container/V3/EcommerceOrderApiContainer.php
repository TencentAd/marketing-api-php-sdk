...
use TencentAds\Api\V3\EcommerceOrderApi;
...
class EcommerceOrderApiContainer extends ApiContainer
{
    ...
    public function get(array $params = [])
    {
        return $this->handleMiddleware('get', $params, function(MiddlewareRequest $request) {
            ...
            $response = $this->apiInstance->ecommerceOrderGet($accountId, $dateRange, $filtering, $date, $page, $pageSize, $fields);
    ...
    public function getAsync(array $params = [])
    {
        return $this->handleMiddleware('get', $params, function(MiddlewareRequest $request) {
            ...
            $pageSize = isset($params['page_size']) ? $params['page_size'] : null;
            $fields = isset($params['fields']) ? $params['fields'] : null;
            $response = $this->apiInstance->ecommerceOrderGetAsync($accountId, $dateRange, $filtering, $date, $page, $pageSize, $fields);
            return $response;
        });
    }
