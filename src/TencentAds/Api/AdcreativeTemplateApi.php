...
/**
 * AdcreativeTemplateApi Class Doc Comment
 *
 * @category Class
 * @package  TencentAds
 * @author   Swagger Codegen team
...
class AdcreativeTemplateApi
{
    ...
    /**
     * Operation adcreativeTemplateGet
     *
     * 获取创意规格详情
     *
    ...
    /**
     * Operation adcreativeTemplateGetWithHttpInfo
     *
     * 获取创意规格详情
     *
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\TencentAds\Model\AdcreativeTemplateGetResponse',
    ...
    /**
     * Operation adcreativeTemplateGetAsync
     *
     * 获取创意规格详情
     *
     * @param  int|mixed $accountId (required)
    ...
    /**
     * Operation adcreativeTemplateGetAsyncWithHttpInfo
     *
     * 获取创意规格详情
     *
     * @param  int|mixed $accountId (required)
    ...
    /**
     * Create request for operation 'adcreativeTemplateGet'
     *
     * @param  int|mixed $accountId (required)
     * @param  string|mixed $promotedObjectType (required)
     * @param  string[]|mixed $siteSet (optional)
    ...
    protected function adcreativeTemplateGetRequest($accountId, $promotedObjectType, $siteSet = null, $automaticSiteEnabled = null, $isDynamicCreative = null, $adcreativeTemplateId = null, $dynamicCreativeType = null, $fields = null)
    {
        ...
        if ($accountId === null || (is_array($accountId) && count($accountId) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $accountId when calling adcreativeTemplateGet'
            );
        }
        ...
        $resourcePath = '/adcreative_template/get';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
