...
class WechatPagesApi
{
     ...
     * @param  \TencentAds\Model\WechatPagesGetFilteringStruct[] $filtering 过滤条件 (optional)
     ...
     * @throws \TencentAds\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \TencentAds\Model\WechatPagesList
     */
     ...
     * @throws \TencentAds\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \TencentAds\Model\WechatPagesList, HTTP status code, HTTP response headers (array of strings)
     */
    public function wechatPagesGetWithHttpInfo($accountId, $filtering = null, $page = null, $pageSize = null, $fields = null)
    {
        $returnType = '\TencentAds\Model\WechatPagesList';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\TencentAds\Model\WechatPagesList',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
