...
class ChannelsApi
{
    ...
    /**
     * Operation channelsDelete
     *
     * 删除广告
     *
     * @param  \TencentAds\Model\ChannelsDeleteRequest $data data (required)
     *
     * @throws \TencentAds\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \TencentAds\Model\ChannelsDeleteResponse
     */
    public function channelsDelete($data)
    {
        list($response) = $this->channelsDeleteWithHttpInfo($data);
        return $response;
    }

    /**
     * Operation channelsDeleteWithHttpInfo
     *
     * 删除广告
     *
     * @param  \TencentAds\Model\ChannelsDeleteRequest $data (required)
     *
     * @throws \TencentAds\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \TencentAds\Model\ChannelsDeleteResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function channelsDeleteWithHttpInfo($data)
    {
        $returnType = '\TencentAds\Model\ChannelsDeleteResponse';
        $request = $this->channelsDeleteRequest($data);
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\TencentAds\Model\ChannelsDeleteResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function channelsDeleteAsync($data)
    {
        return $this->channelsDeleteAsyncWithHttpInfo($data)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation channelsDeleteAsyncWithHttpInfo
     *
     * 删除广告
     *
     * @param  \TencentAds\Model\ChannelsDeleteRequest $data (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function channelsDeleteAsyncWithHttpInfo($data)
    {
        $returnType = '\TencentAds\Model\ChannelsDeleteResponse';
        $request = $this->channelsDeleteRequest($data);
    ...
    /**
     * Create request for operation 'channelsDelete'
     *
     * @param  \TencentAds\Model\ChannelsDeleteRequest $data (required)
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function channelsDeleteRequest($data)
    {
        // verify the required parameter 'data' is set
        if ($data === null || (is_array($data) && count($data) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $data when calling channelsDelete'
            );
        }

        $resourcePath = '/channels/delete';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
