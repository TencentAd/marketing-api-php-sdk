...
class FundStatementsDailyApi
{
     ...
     * @param  string $tradeType 交易类型 (optional)
     * @param  string[] $fields 返回参数的字段列表 (optional)
     *
     * @throws \TencentAds\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \TencentAds\Model\FundStatementsDailyList
     */
     ...
     * @throws \TencentAds\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \TencentAds\Model\FundStatementsDailyList, HTTP status code, HTTP response headers (array of strings)
     */
    public function fundStatementsDailyGetWithHttpInfo($accountId, $fundType, $dateRange, $tradeType = null, $fields = null)
    {
        $returnType = '\TencentAds\Model\FundStatementsDailyList';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\TencentAds\Model\FundStatementsDailyList',
