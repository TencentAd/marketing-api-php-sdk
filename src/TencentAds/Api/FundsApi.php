...
class FundsApi
{
     ...
     * @return \TencentAds\Model\FundsList
     */
    ...
    /**
     * Operation fundsGetWithHttpInfo
     *
     * 获取资金账户信息
     *
     * @param  int $accountId 推广帐号 id，有操作权限的帐号 id，包括代理商和广告主帐号id (required)
     ...
     * @throws \TencentAds\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \TencentAds\Model\FundsList, HTTP status code, HTTP response headers (array of strings)
     */
    public function fundsGetWithHttpInfo($accountId, $fields = null)
    {
        $returnType = '\TencentAds\Model\FundsList';
    ...
    /**
     * Operation fundsGetAsyncWithHttpInfo
     *
     * 获取资金账户信息
     *
     * @param  int $accountId 推广帐号 id，有操作权限的帐号 id，包括代理商和广告主帐号id (required)
