...
class FundsApi
{
     ...
     * @throws \TencentAds\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \TencentAds\Model\FundsGetResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function fundsGetWithHttpInfo($accountId, $fields = null)
    {
        $returnType = '\TencentAds\Model\FundsGetResponse';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\TencentAds\Model\FundsGetResponse',
