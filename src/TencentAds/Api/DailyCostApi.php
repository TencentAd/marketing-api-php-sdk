...
class DailyCostApi
{
     ...
     * @throws \TencentAds\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \TencentAds\Model\DailyCostGetResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function dailyCostGetWithHttpInfo($dateRange, $accountId = null, $filtering = null, $page = null, $pageSize = null, $fields = null)
    {
        $returnType = '\TencentAds\Model\DailyCostGetResponse';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\TencentAds\Model\DailyCostGetResponse',
