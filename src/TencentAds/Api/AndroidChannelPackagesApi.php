...
/**
 * AndroidChannelPackagesApi Class Doc Comment
 *
 * @category Class
 * @package  TencentAds
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class AndroidChannelPackagesApi
{
    /**
     * @var ClientInterface
     */
    ...
    /**
     * Operation androidChannelPackagesGet
     *
     * 获取安卓渠道包
     *
     * @param  int $accountId 推广帐号 id，有操作权限的帐号 id，包括代理商和广告主帐号id (required)
     * @param  string $myappAuthKey api授权id，在应用宝账号下分配。 (required)
     * @param  int $androidAppId 应用宝APP ID (required)
     ...
     * @return \TencentAds\Model\AndroidChannelPackagesList
     */
    ...
    /**
     * Operation androidChannelPackagesGetWithHttpInfo
     *
     * 获取安卓渠道包
     *
     * @param  int $accountId 推广帐号 id，有操作权限的帐号 id，包括代理商和广告主帐号id (required)
     ...
     * @throws \TencentAds\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \TencentAds\Model\AndroidChannelPackagesList, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    {
        $returnType = '\TencentAds\Model\AndroidChannelPackagesList';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\TencentAds\Model\AndroidChannelPackagesList',
    ...
    /**
     * Operation androidChannelPackagesGetAsync
     *
     * 获取安卓渠道包
     *
     * @param  int $accountId 推广帐号 id，有操作权限的帐号 id，包括代理商和广告主帐号id (required)
    ...
    /**
     * Operation androidChannelPackagesGetAsyncWithHttpInfo
     *
     * 获取安卓渠道包
     *
     * @param  int $accountId 推广帐号 id，有操作权限的帐号 id，包括代理商和广告主帐号id (required)
    ...
    protected function androidChannelPackagesGetRequest($accountId, $myappAuthKey, $androidAppId, $page = null, $pageSize = null, $fields = null)
    {
        ...
        if ($androidAppId === null || (is_array($androidAppId) && count($androidAppId) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $androidAppId when calling androidChannelPackagesGet'
            );
        }

        $resourcePath = '/android_channel_packages/get';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        if ($myappAuthKey !== null) {
            $queryParams['myapp_auth_key'] = ObjectSerializer::toQueryValue($myappAuthKey);
        }
        // query params
