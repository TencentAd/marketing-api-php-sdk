...
/**
 * VideomakerVideocapturesApi Class Doc Comment
 *
 * @category Class
 * @package  TencentAds
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class VideomakerVideocapturesApi
{
    /**
     * @var ClientInterface
     */
    ...
    /**
     * Operation videomakerVideocapturesAdd
     *
     * 生成视频封面图
     *
    ...
    /**
     * Operation videomakerVideocapturesAddWithHttpInfo
     *
     * 生成视频封面图
     *
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\TencentAds\Model\VideomakerVideocapturesAddResponse',
    ...
    /**
     * Operation videomakerVideocapturesAddAsync
     *
     * 生成视频封面图
     *
     * @param  int $accountId (required)
    ...
    /**
     * Operation videomakerVideocapturesAddAsyncWithHttpInfo
     *
     * 生成视频封面图
     *
     * @param  int $accountId (required)
    ...
    protected function videomakerVideocapturesAddRequest($accountId, $videoId = null, $videoFile = null, $signature = null, $number = null)
    {
        ...
        if ($accountId === null || (is_array($accountId) && count($accountId) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $accountId when calling videomakerVideocapturesAdd'
            );
        }

        $resourcePath = '/videomaker_videocaptures/add';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
