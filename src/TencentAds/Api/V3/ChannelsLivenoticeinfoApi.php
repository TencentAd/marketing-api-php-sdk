...
/**
 * ChannelsLivenoticeinfoApi Class Doc Comment
 *
 * @category Class
 * @package  TencentAds
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ChannelsLivenoticeinfoApi
{
    /**
     * @var ClientInterface
     */
    ...
    /**
     * Operation channelsLivenoticeinfoGet
     *
     * 获取视频号当前的预约直播信息
     *
    ...
    /**
     * Operation channelsLivenoticeinfoGetWithHttpInfo
     *
     * 获取视频号当前的预约直播信息
     *
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\TencentAds\Model\V3\ChannelsLivenoticeinfoGetResponse',
    ...
    /**
     * Operation channelsLivenoticeinfoGetAsync
     *
     * 获取视频号当前的预约直播信息
     *
     * @param  int|mixed $accountId (required)
    ...
    /**
     * Operation channelsLivenoticeinfoGetAsyncWithHttpInfo
     *
     * 获取视频号当前的预约直播信息
     *
     * @param  int|mixed $accountId (required)
    ...
    /**
     * Create request for operation 'channelsLivenoticeinfoGet'
     *
     * @param  int|mixed $accountId (required)
     * @param  string|mixed $finderUsername (optional)
     * @param  string|mixed $nickname (optional)
    ...
    protected function channelsLivenoticeinfoGetRequest($accountId, $finderUsername = null, $nickname = null, $wechatChannelsAccountId = null, $fields = null)
    {
        ...
        if ($accountId === null || (is_array($accountId) && count($accountId) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $accountId when calling channelsLivenoticeinfoGet'
            );
        }

        $resourcePath = '/channels_livenoticeinfo/get';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
