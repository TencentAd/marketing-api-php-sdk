...
/**
 * AgencyWalletListApi Class Doc Comment
 *
 * @category Class
 * @package  TencentAds
 * @author   Swagger Codegen team
...
class AgencyWalletListApi
{
    ...
    /**
     * Operation agencyWalletListGetWithHttpInfo
     *
     * 获取代理商创建的共享钱包信息列表
     *
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\TencentAds\Model\V3\AgencyWalletListGetResponse',
    ...
    /**
     * Operation agencyWalletListGetAsync
     *
     * 获取代理商创建的共享钱包信息列表
     *
     * @param  int|mixed $accountId (required)
    ...
    /**
     * Operation agencyWalletListGetAsyncWithHttpInfo
     *
     * 获取代理商创建的共享钱包信息列表
     *
     * @param  int|mixed $accountId (required)
    ...
    protected function agencyWalletListGetRequest($accountId, $page, $pageSize, $mdmId = null, $walletId = null, $fields = null)
    {
        ...
        $resourcePath = '/agency_wallet_list/get';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        // query params
        if ($mdmId !== null) {
            $queryParams['mdm_id'] = ObjectSerializer::toQueryValue($mdmId);
        }
        // query params
        if ($walletId !== null) {
