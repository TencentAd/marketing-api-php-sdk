...
/**
 * WechatShopApi Class Doc Comment
 *
 * @category Class
 * @package  TencentAds
 * @author   Swagger Codegen team
...
class WechatShopApi
{
    ...
    /**
     * Operation wechatShopGetWithHttpInfo
     *
     * 查询微信小店信息
     *
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\TencentAds\Model\V3\WechatShopGetResponse',
    ...
    /**
     * Operation wechatShopGetAsyncWithHttpInfo
     *
     * 查询微信小店信息
     *
     * @param  int|mixed $accountId (required)
