<?php
/**
 * WechatChannelsAdAccountValidationApi
 * PHP version 5
 *
 * @category Class
 * @package  TencentAds
...
/**
 * WechatChannelsAdAccountValidationApi Class Doc Comment
 *
 * @category Class
 * @package  TencentAds
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class WechatChannelsAdAccountValidationApi
{
    /**
     * @var ClientInterface
     */
    ...
    /**
     * Operation wechatChannelsAdAccountValidationGet
     *
     * 视频号一键开户校验
     *
    ...
    /**
     * Operation wechatChannelsAdAccountValidationGetWithHttpInfo
     *
     * 视频号一键开户校验
     *
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\TencentAds\Model\V3\WechatChannelsAdAccountValidationGetResponse',
    ...
    /**
     * Operation wechatChannelsAdAccountValidationGetAsync
     *
     * 视频号一键开户校验
     *
     * @param  int|mixed $accountId (required)
    ...
    /**
     * Operation wechatChannelsAdAccountValidationGetAsyncWithHttpInfo
     *
     * 视频号一键开户校验
     *
     * @param  int|mixed $accountId (required)
    ...
    /**
     * Create request for operation 'wechatChannelsAdAccountValidationGet'
     *
     * @param  int|mixed $accountId (required)
     * @param  string|mixed $nickname (optional)
     * @param  string|mixed $headImageId (optional)
    ...
    protected function wechatChannelsAdAccountValidationGetRequest($accountId, $nickname = null, $headImageId = null, $wechatChannelsAccountId = null, $fields = null)
    {
        ...
        if ($accountId === null || (is_array($accountId) && count($accountId) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $accountId when calling wechatChannelsAdAccountValidationGet'
            );
        }

        $resourcePath = '/wechat_channels_ad_account_validation/get';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
