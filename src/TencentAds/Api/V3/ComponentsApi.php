...
class ComponentsApi
{
    ...
    /**
     * Operation componentsAdd
     *
     * 创建创意组件
     *
     * @param  \TencentAds\Model\V3\ComponentsAddRequest|mixed $data data (required)
     *
     * @throws \TencentAds\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \TencentAds\Model\V3\ComponentsAddResponse|mixed
     */
    public function componentsAdd($data)
    {
        list($response) = $this->componentsAddWithHttpInfo($data);
        return $response;
    }

    /**
     * Operation componentsAddWithHttpInfo
     *
     * 创建创意组件
     *
     * @param  \TencentAds\Model\V3\ComponentsAddRequest|mixed $data (required)
     *
     * @throws \TencentAds\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \TencentAds\Model\V3\ComponentsAddResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function componentsAddWithHttpInfo($data)
    {
        $returnType = '\TencentAds\Model\V3\ComponentsAddResponse';
        $request = $this->componentsAddRequest($data);
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\TencentAds\Model\V3\ComponentsAddResponse',
     ...
     */
    public function componentsAddAsync($data)
    {
        return $this->componentsAddAsyncWithHttpInfo($data)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation componentsAddAsyncWithHttpInfo
     *
     * 创建创意组件
     *
     * @param  \TencentAds\Model\V3\ComponentsAddRequest|mixed $data (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function componentsAddAsyncWithHttpInfo($data)
    {
        $returnType = '\TencentAds\Model\V3\ComponentsAddResponse';
        $request = $this->componentsAddRequest($data);
    ...
    /**
     * Create request for operation 'componentsAdd'
     *
     * @param  \TencentAds\Model\V3\ComponentsAddRequest|mixed $data (required)
     *
     * @throws \InvalidArgumentException
     ...
     */
    protected function componentsAddRequest($data)
    {
        // verify the required parameter 'data' is set
        if ($data === null || (is_array($data) && count($data) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $data when calling componentsAdd'
            );
        }

        $resourcePath = '/components/add';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation componentsDelete
     *
     * 删除创意组件
     *
     * @param  \TencentAds\Model\V3\ComponentsDeleteRequest|mixed $data data (required)
     *
     * @throws \TencentAds\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \TencentAds\Model\V3\ComponentsDeleteResponse|mixed
     */
    public function componentsDelete($data)
    {
        list($response) = $this->componentsDeleteWithHttpInfo($data);
        return $response;
    }

    /**
     * Operation componentsDeleteWithHttpInfo
     *
     * 删除创意组件
     *
     * @param  \TencentAds\Model\V3\ComponentsDeleteRequest|mixed $data (required)
     *
     * @throws \TencentAds\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \TencentAds\Model\V3\ComponentsDeleteResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function componentsDeleteWithHttpInfo($data)
    {
        $returnType = '\TencentAds\Model\V3\ComponentsDeleteResponse';
        $request = $this->componentsDeleteRequest($data);
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\TencentAds\Model\V3\ComponentsDeleteResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    /**
     * Operation componentsDeleteAsync
     *
     * 删除创意组件
     *
     * @param  \TencentAds\Model\V3\ComponentsDeleteRequest|mixed $data (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function componentsDeleteAsync($data)
    {
        return $this->componentsDeleteAsyncWithHttpInfo($data)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation componentsDeleteAsyncWithHttpInfo
     *
     * 删除创意组件
     *
     * @param  \TencentAds\Model\V3\ComponentsDeleteRequest|mixed $data (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function componentsDeleteAsyncWithHttpInfo($data)
    {
        $returnType = '\TencentAds\Model\V3\ComponentsDeleteResponse';
        $request = $this->componentsDeleteRequest($data);
    ...
    /**
     * Create request for operation 'componentsDelete'
     *
     * @param  \TencentAds\Model\V3\ComponentsDeleteRequest|mixed $data (required)
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function componentsDeleteRequest($data)
    {
        // verify the required parameter 'data' is set
        if ($data === null || (is_array($data) && count($data) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $data when calling componentsDelete'
            );
        }

        $resourcePath = '/components/delete';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation componentsGetWithHttpInfo
     *
     * 获取创意组件
     *
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\TencentAds\Model\V3\ComponentsGetResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    /**
     * Operation componentsGetAsyncWithHttpInfo
     *
     * 获取创意组件
     *
     * @param  int|mixed $accountId (optional)
