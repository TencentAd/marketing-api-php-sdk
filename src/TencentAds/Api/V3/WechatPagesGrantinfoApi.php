...
class WechatPagesGrantinfoApi
{
     ...
     * @param  string|mixed $searchKey searchKey (optional)
     ...
     * @return \TencentAds\Model\V3\WechatPagesGrantinfoGetResponse|mixed
     */
     ...
     * @param  string|mixed $searchKey (optional)
     ...
     * @throws \TencentAds\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \TencentAds\Model\V3\WechatPagesGrantinfoGetResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function wechatPagesGrantinfoGetWithHttpInfo($accountId, $searchKey = null, $page = null, $pageSize = null, $fields = null)
    {
        $returnType = '\TencentAds\Model\V3\WechatPagesGrantinfoGetResponse';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\TencentAds\Model\V3\WechatPagesGrantinfoGetResponse',
