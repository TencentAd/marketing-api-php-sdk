...
/**
 * OrganizationAccountRelationApi Class Doc Comment
 *
 * @category Class
 * @package  TencentAds
 * @author   Swagger Codegen team
...
class OrganizationAccountRelationApi
{
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\TencentAds\Model\V3\OrganizationAccountRelationGetResponse',
    ...
    /**
     * Create request for operation 'organizationAccountRelationGet'
     *
     * @param  string|mixed $paginationMode (required)
     * @param  int|mixed $accountId (optional)
     * @param  string|mixed $advertiserType (optional)
    ...
    protected function organizationAccountRelationGetRequest($paginationMode, $accountId = null, $advertiserType = null, $businessUnitId = null, $cursor = null, $page = null, $pageSize = null, $fields = null)
    {
        ...
        if ($paginationMode === null || (is_array($paginationMode) && count($paginationMode) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $paginationMode when calling organizationAccountRelationGet'
            );
        }

        $resourcePath = '/organization_account_relation/get';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
