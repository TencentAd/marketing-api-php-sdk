...
class AsyncReportsApi
{
     ...
     * 创建异步报表任务
     *
     * @param  \TencentAds\Model\V3\AsyncReportsAddRequest|mixed $data data (required)
     *
     * @throws \TencentAds\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \TencentAds\Model\V3\AsyncReportsAddResponse|mixed
     */
     ...
     * 创建异步报表任务
     *
     * @param  \TencentAds\Model\V3\AsyncReportsAddRequest|mixed $data (required)
     *
     * @throws \TencentAds\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \TencentAds\Model\V3\AsyncReportsAddResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function asyncReportsAddWithHttpInfo($data)
    {
        $returnType = '\TencentAds\Model\V3\AsyncReportsAddResponse';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\TencentAds\Model\V3\AsyncReportsAddResponse',
     ...
     * @param  \TencentAds\Model\V3\AsyncReportsFilteringStruct[]|mixed $filtering filtering (optional)
     ...
     * @param  \TencentAds\Model\V3\AsyncReportsFilteringStruct[]|mixed $filtering (optional)
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\TencentAds\Model\V3\AsyncReportsGetResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
