...
/**
 * ConversionLinksApi Class Doc Comment
 *
 * @category Class
 * @package  TencentAds
 * @author   Swagger Codegen team
...
class ConversionLinksApi
{
    ...
    /**
     * Operation conversionLinksGetWithHttpInfo
     *
     * 获取营销链路模板
     *
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\TencentAds\Model\V3\ConversionLinksGetResponse',
    ...
    /**
     * Operation conversionLinksGetAsync
     *
     * 获取营销链路模板
     *
     * @param  int|mixed $accountId (required)
    ...
    /**
     * Operation conversionLinksGetAsyncWithHttpInfo
     *
     * 获取营销链路模板
     *
     * @param  int|mixed $accountId (required)
    ...
    /**
     * Create request for operation 'conversionLinksGet'
     *
     * @param  int|mixed $accountId (required)
     * @param  string|mixed $secondCategoryType (required)
     * @param  \TencentAds\Model\V3\LinkOptimizationGoalStruct|mixed $optimizationGoalStruct (optional)
    ...
    protected function conversionLinksGetRequest($accountId, $secondCategoryType, $optimizationGoalStruct = null, $fields = null)
    {
        ...
        if ($accountId === null || (is_array($accountId) && count($accountId) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $accountId when calling conversionLinksGet'
            );
        }
        // verify the required parameter 'secondCategoryType' is set
        if ($secondCategoryType === null || (is_array($secondCategoryType) && count($secondCategoryType) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $secondCategoryType when calling conversionLinksGet'
            );
        }

        $resourcePath = '/conversion_links/get';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
