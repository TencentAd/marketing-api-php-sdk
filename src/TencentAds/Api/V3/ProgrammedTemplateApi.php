...
class ProgrammedTemplateApi
{
     ...
     * 获取模板列表接口
     *
     * @param  \TencentAds\Model\V3\ProgrammedTemplateGetRequest|mixed $data data (required)
     *
     * @throws \TencentAds\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \TencentAds\Model\V3\ProgrammedTemplateGetResponse|mixed
     */
     ...
     * 获取模板列表接口
     *
     * @param  \TencentAds\Model\V3\ProgrammedTemplateGetRequest|mixed $data (required)
     *
     * @throws \TencentAds\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \TencentAds\Model\V3\ProgrammedTemplateGetResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function programmedTemplateGetWithHttpInfo($data)
    {
        $returnType = '\TencentAds\Model\V3\ProgrammedTemplateGetResponse';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\TencentAds\Model\V3\ProgrammedTemplateGetResponse',
