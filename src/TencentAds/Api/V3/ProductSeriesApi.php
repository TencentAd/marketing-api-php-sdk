...
class ProductSeriesApi
{
    ...
    /**
     * Operation productSeriesAdd
     *
     * 创建商品系列
     *
     * @param  \TencentAds\Model\V3\ProductSeriesAddRequest|mixed $data data (required)
     *
     * @throws \TencentAds\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \TencentAds\Model\V3\ProductSeriesAddResponse|mixed
     */
    public function productSeriesAdd($data)
    {
        list($response) = $this->productSeriesAddWithHttpInfo($data);
        return $response;
    }

    /**
     * Operation productSeriesAddWithHttpInfo
     *
     * 创建商品系列
     *
     * @param  \TencentAds\Model\V3\ProductSeriesAddRequest|mixed $data (required)
     *
     * @throws \TencentAds\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \TencentAds\Model\V3\ProductSeriesAddResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function productSeriesAddWithHttpInfo($data)
    {
        $returnType = '\TencentAds\Model\V3\ProductSeriesAddResponse';
        $request = $this->productSeriesAddRequest($data);
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\TencentAds\Model\V3\ProductSeriesAddResponse',
    ...
    /**
     * Operation productSeriesAddAsync
     *
     * 创建商品系列
     *
     * @param  \TencentAds\Model\V3\ProductSeriesAddRequest|mixed $data (required)
     ...
     */
    public function productSeriesAddAsync($data)
    {
        return $this->productSeriesAddAsyncWithHttpInfo($data)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation productSeriesAddAsyncWithHttpInfo
     *
     * 创建商品系列
     *
     * @param  \TencentAds\Model\V3\ProductSeriesAddRequest|mixed $data (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function productSeriesAddAsyncWithHttpInfo($data)
    {
        $returnType = '\TencentAds\Model\V3\ProductSeriesAddResponse';
        $request = $this->productSeriesAddRequest($data);
    ...
    /**
     * Create request for operation 'productSeriesAdd'
     *
     * @param  \TencentAds\Model\V3\ProductSeriesAddRequest|mixed $data (required)
     *
     * @throws \InvalidArgumentException
     ...
     */
    protected function productSeriesAddRequest($data)
    {
        // verify the required parameter 'data' is set
        if ($data === null || (is_array($data) && count($data) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $data when calling productSeriesAdd'
            );
        }

        $resourcePath = '/product_series/add';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @param  int|mixed $catalogId catalogId (required)
     * @param  \TencentAds\Model\V3\ProductSeriesSearchFilteringStruct[]|mixed $filtering filtering (optional)
     ...
     * @throws \TencentAds\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \TencentAds\Model\V3\ProductSeriesGetResponse|mixed
     */
     ...
     * @param  int|mixed $catalogId (required)
     * @param  \TencentAds\Model\V3\ProductSeriesSearchFilteringStruct[]|mixed $filtering (optional)
     ...
     * @throws \TencentAds\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \TencentAds\Model\V3\ProductSeriesGetResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function productSeriesGetWithHttpInfo($accountId, $catalogId, $filtering = null, $page = null, $pageSize = null, $fields = null)
    {
        $returnType = '\TencentAds\Model\V3\ProductSeriesGetResponse';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\TencentAds\Model\V3\ProductSeriesGetResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
