...
class OptimizationGoalPermissionsApi
{
     ...
     * @param  string|mixed $marketingSubGoal marketingSubGoal (required)
     ...
     * @param  string|mixed $marketingSubGoal (required)
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\TencentAds\Model\V3\OptimizationGoalPermissionsGetResponse',
    ...
    protected function optimizationGoalPermissionsGetRequest($accountId, $siteSet, $marketingGoal, $marketingSubGoal, $marketingCarrierType, $marketingTargetType, $bidMode = null, $marketingCarrierDetail = null, $fields = null)
    {
        ...
        if ($marketingGoal === null || (is_array($marketingGoal) && count($marketingGoal) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $marketingGoal when calling optimizationGoalPermissionsGet'
            );
        }
        // verify the required parameter 'marketingSubGoal' is set
        if ($marketingSubGoal === null || (is_array($marketingSubGoal) && count($marketingSubGoal) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $marketingSubGoal when calling optimizationGoalPermissionsGet'
            );
        }
        ...
        if ($marketingCarrierType === null || (is_array($marketingCarrierType) && count($marketingCarrierType) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $marketingCarrierType when calling optimizationGoalPermissionsGet'
            );
        }
        ...
        if ($marketingTargetType === null || (is_array($marketingTargetType) && count($marketingTargetType) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $marketingTargetType when calling optimizationGoalPermissionsGet'
            );
        }
