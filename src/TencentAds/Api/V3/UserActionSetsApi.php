...
class UserActionSetsApi
{
     ...
     * 创建用户行为数据源
     *
     * @param  \TencentAds\Model\V3\UserActionSetsAddRequest|mixed $data data (required)
     *
     * @throws \TencentAds\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \TencentAds\Model\V3\UserActionSetsAddResponse|mixed
     */
     ...
     * 创建用户行为数据源
     *
     * @param  \TencentAds\Model\V3\UserActionSetsAddRequest|mixed $data (required)
     *
     * @throws \TencentAds\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \TencentAds\Model\V3\UserActionSetsAddResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function userActionSetsAddWithHttpInfo($data)
    {
        $returnType = '\TencentAds\Model\V3\UserActionSetsAddResponse';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\TencentAds\Model\V3\UserActionSetsAddResponse',
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\TencentAds\Model\V3\UserActionSetsGetResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    protected function userActionSetsGetRequest($accountId, $userActionSetId = null, $type = null, $mobileAppId = null, $wechatAppId = null, $name = null, $includePermission = null, $fields = null)
    {
        ...
        // query params
        if (is_array($type)) {
           $queryParams['type'] = json_encode($type);
        } else
        if ($type !== null) {
