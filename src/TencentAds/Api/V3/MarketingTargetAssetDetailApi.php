...
/**
 * MarketingTargetAssetDetailApi Class Doc Comment
 *
 * @category Class
 * @package  TencentAds
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class MarketingTargetAssetDetailApi
{
    /**
     * @var ClientInterface
     */
    ...
    /**
     * Operation marketingTargetAssetDetailGet
     *
     * 获取推广内容资产详情
     *
    ...
    /**
     * Operation marketingTargetAssetDetailGetWithHttpInfo
     *
     * 获取推广内容资产详情
     *
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\TencentAds\Model\V3\MarketingTargetAssetDetailGetResponse',
    ...
    /**
     * Operation marketingTargetAssetDetailGetAsync
     *
     * 获取推广内容资产详情
     *
     * @param  int|mixed $marketingAssetId (required)
    ...
    /**
     * Operation marketingTargetAssetDetailGetAsyncWithHttpInfo
     *
     * 获取推广内容资产详情
     *
     * @param  int|mixed $marketingAssetId (required)
    ...
    protected function marketingTargetAssetDetailGetRequest($marketingAssetId, $marketingTargetType, $accountId = null, $organizationId = null, $fields = null)
    {
        ...
        if ($marketingAssetId === null || (is_array($marketingAssetId) && count($marketingAssetId) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $marketingAssetId when calling marketingTargetAssetDetailGet'
            );
        }
        ...
        if ($marketingTargetType === null || (is_array($marketingTargetType) && count($marketingTargetType) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $marketingTargetType when calling marketingTargetAssetDetailGet'
            );
        }

        $resourcePath = '/marketing_target_asset_detail/get';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
