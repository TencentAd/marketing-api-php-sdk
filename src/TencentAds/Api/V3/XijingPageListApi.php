...
class XijingPageListApi
{
     ...
     * @param  int|mixed $pageId pageId (optional)
     * @param  string|mixed $pageServiceId pageServiceId (optional)
     * @param  string|mixed $pageName pageName (optional)
     * @param  string[]|mixed $pageType pageType (optional)
     * @param  string|mixed $pageLastModifyStartTime pageLastModifyStartTime (optional)
     * @param  string|mixed $pageLastModifyEndTime pageLastModifyEndTime (optional)
     * @param  int|mixed $pageSize pageSize (optional)
     * @param  int|mixed $pageIndex pageIndex (optional)
     * @param  string[]|mixed $pagePublishStatus pagePublishStatus (optional)
     * @param  string[]|mixed $pageStatus pageStatus (optional)
     * @param  string|mixed $pageSource pageSource (optional)
     * @param  int|mixed $pageOwnerId pageOwnerId (optional)
     * @param  int|mixed $appId appId (optional)
     * @param  string|mixed $appType appType (optional)
     * @param  string|mixed $queryType queryType (optional)
     * @param  string[]|mixed $fields 返回参数的字段列表 (optional)
     *
     * @throws \TencentAds\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \TencentAds\Model\V3\XijingPageListGetResponse|mixed
     */
     ...
     * @param  int|mixed $pageId (optional)
     * @param  string|mixed $pageServiceId (optional)
     * @param  string|mixed $pageName (optional)
     * @param  string[]|mixed $pageType (optional)
     * @param  string|mixed $pageLastModifyStartTime (optional)
     * @param  string|mixed $pageLastModifyEndTime (optional)
     * @param  int|mixed $pageSize (optional)
     * @param  int|mixed $pageIndex (optional)
     * @param  string[]|mixed $pagePublishStatus (optional)
     * @param  string[]|mixed $pageStatus (optional)
     * @param  string|mixed $pageSource (optional)
     * @param  int|mixed $pageOwnerId (optional)
     * @param  int|mixed $appId (optional)
     * @param  string|mixed $appType (optional)
     * @param  string|mixed $queryType (optional)
     * @param  string[]|mixed $fields 返回参数的字段列表 (optional)
     *
     * @throws \TencentAds\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \TencentAds\Model\V3\XijingPageListGetResponse, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    {
        $returnType = '\TencentAds\Model\V3\XijingPageListGetResponse';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\TencentAds\Model\V3\XijingPageListGetResponse',
