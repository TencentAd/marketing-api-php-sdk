...
class AdvertiserApi
{
     ...
     * 添加腾讯广告服务商子客
     *
     * @param  \TencentAds\Model\V3\AdvertiserAddRequest|mixed $data data (required)
     *
     * @throws \TencentAds\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \TencentAds\Model\V3\AdvertiserAddResponse|mixed
     */
     ...
     * 添加腾讯广告服务商子客
     *
     * @param  \TencentAds\Model\V3\AdvertiserAddRequest|mixed $data (required)
     *
     * @throws \TencentAds\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \TencentAds\Model\V3\AdvertiserAddResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function advertiserAddWithHttpInfo($data)
    {
        $returnType = '\TencentAds\Model\V3\AdvertiserAddResponse';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\TencentAds\Model\V3\AdvertiserAddResponse',
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\TencentAds\Model\V3\AdvertiserGetResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    protected function advertiserGetRequest($fields, $paginationMode, $pageSize, $agencyId = null, $advertiserId = null, $filtering = null, $page = null, $cursor = null)
    {
        ...
        if ($fields === null || (is_array($fields) && count($fields) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $fields when calling advertiserGet'
            );
        }
        // verify the required parameter 'paginationMode' is set
        if ($paginationMode === null || (is_array($paginationMode) && count($paginationMode) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $paginationMode when calling advertiserGet'
            );
        }
        // verify the required parameter 'pageSize' is set
        if ($pageSize === null || (is_array($pageSize) && count($pageSize) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $pageSize when calling advertiserGet'
            );
        }
     ...
     * 更新腾讯广告广告主信息
     *
     * @param  \TencentAds\Model\V3\AdvertiserUpdateRequest|mixed $data data (required)
     *
     * @throws \TencentAds\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \TencentAds\Model\V3\AdvertiserUpdateResponse|mixed
     */
     ...
     * 更新腾讯广告广告主信息
     *
     * @param  \TencentAds\Model\V3\AdvertiserUpdateRequest|mixed $data (required)
     *
     * @throws \TencentAds\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \TencentAds\Model\V3\AdvertiserUpdateResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function advertiserUpdateWithHttpInfo($data)
    {
        $returnType = '\TencentAds\Model\V3\AdvertiserUpdateResponse';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\TencentAds\Model\V3\AdvertiserUpdateResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \TencentAds\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \TencentAds\Model\V3\AdvertiserUpdateDailyBudgetResponse|mixed
     */
     ...
     * @throws \TencentAds\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \TencentAds\Model\V3\AdvertiserUpdateDailyBudgetResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function advertiserUpdateDailyBudgetWithHttpInfo($data)
    {
        $returnType = '\TencentAds\Model\V3\AdvertiserUpdateDailyBudgetResponse';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\TencentAds\Model\V3\AdvertiserUpdateDailyBudgetResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
