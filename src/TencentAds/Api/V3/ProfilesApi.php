...
class ProfilesApi
{
     ...
     * 创建朋友圈头像昵称跳转页
     *
     * @param  \TencentAds\Model\V3\ProfilesAddRequest|mixed $data data (required)
     *
     * @throws \TencentAds\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \TencentAds\Model\V3\ProfilesAddResponse|mixed
     */
     ...
     * 创建朋友圈头像昵称跳转页
     *
     * @param  \TencentAds\Model\V3\ProfilesAddRequest|mixed $data (required)
     *
     * @throws \TencentAds\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \TencentAds\Model\V3\ProfilesAddResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function profilesAddWithHttpInfo($data)
    {
        $returnType = '\TencentAds\Model\V3\ProfilesAddResponse';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\TencentAds\Model\V3\ProfilesAddResponse',
     ...
     * 删除朋友圈头像昵称跳转页
     *
     * @param  \TencentAds\Model\V3\ProfilesDeleteRequest|mixed $data data (required)
     *
     * @throws \TencentAds\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \TencentAds\Model\V3\ProfilesDeleteResponse|mixed
     */
     ...
     * 删除朋友圈头像昵称跳转页
     *
     * @param  \TencentAds\Model\V3\ProfilesDeleteRequest|mixed $data (required)
     *
     * @throws \TencentAds\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \TencentAds\Model\V3\ProfilesDeleteResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function profilesDeleteWithHttpInfo($data)
    {
        $returnType = '\TencentAds\Model\V3\ProfilesDeleteResponse';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\TencentAds\Model\V3\ProfilesDeleteResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\TencentAds\Model\V3\ProfilesGetResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
