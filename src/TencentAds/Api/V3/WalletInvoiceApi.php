...
/**
 * WalletInvoiceApi Class Doc Comment
 *
 * @category Class
 * @package  TencentAds
 * @author   Swagger Codegen team
...
class WalletInvoiceApi
{
    ...
    /**
     * Operation walletInvoiceGet
     *
     * 共享钱包流水相关信息查询
     *
     * @param  int|mixed $accountId accountId (required)
     * @param  string|mixed $walletIdList walletIdList (required)
     * @param  \TencentAds\Model\V3\WalletDateRangeTransaction|mixed $dateRange dateRange (required)
    ...
    /**
     * Operation walletInvoiceGetWithHttpInfo
     *
     * 共享钱包流水相关信息查询
     *
     * @param  int|mixed $accountId (required)
     * @param  string|mixed $walletIdList (required)
     * @param  \TencentAds\Model\V3\WalletDateRangeTransaction|mixed $dateRange (required)
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\TencentAds\Model\V3\WalletInvoiceGetResponse',
    ...
    /**
     * Operation walletInvoiceGetAsync
     *
     * 共享钱包流水相关信息查询
     *
     * @param  int|mixed $accountId (required)
    ...
    /**
     * Operation walletInvoiceGetAsyncWithHttpInfo
     *
     * 共享钱包流水相关信息查询
     *
     * @param  int|mixed $accountId (required)
    ...
    /**
     * Create request for operation 'walletInvoiceGet'
     *
     * @param  int|mixed $accountId (required)
     * @param  string|mixed $walletIdList (required)
     * @param  \TencentAds\Model\V3\WalletDateRangeTransaction|mixed $dateRange (required)
    ...
    protected function walletInvoiceGetRequest($accountId, $walletIdList, $dateRange, $fundType = null, $page = null, $pageSize = null, $fields = null)
    {
        ...
        if ($accountId === null || (is_array($accountId) && count($accountId) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $accountId when calling walletInvoiceGet'
            );
        }
        // verify the required parameter 'walletIdList' is set
        if ($walletIdList === null || (is_array($walletIdList) && count($walletIdList) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $walletIdList when calling walletInvoiceGet'
            );
        }
        // verify the required parameter 'dateRange' is set
        if ($dateRange === null || (is_array($dateRange) && count($dateRange) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $dateRange when calling walletInvoiceGet'
            );
        }

        $resourcePath = '/wallet_invoice/get';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        if ($walletIdList !== null) {
            $queryParams['wallet_id_list'] = ObjectSerializer::toQueryValue($walletIdList);
        }
        // query params
        if ($fundType !== null) {
