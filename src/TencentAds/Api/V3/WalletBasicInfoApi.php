...
/**
 * WalletBasicInfoApi Class Doc Comment
 *
 * @category Class
 * @package  TencentAds
 * @author   Swagger Codegen team
...
class WalletBasicInfoApi
{
    ...
    /**
     * Operation walletBasicInfoGetWithHttpInfo
     *
     * 通过钱包id去查询共享钱包基础信息
     *
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\TencentAds\Model\V3\WalletBasicInfoGetResponse',
    ...
    /**
     * Operation walletBasicInfoGetAsync
     *
     * 通过钱包id去查询共享钱包基础信息
     *
     * @param  int|mixed $accountId (required)
    ...
    /**
     * Operation walletBasicInfoGetAsyncWithHttpInfo
     *
     * 通过钱包id去查询共享钱包基础信息
     *
     * @param  int|mixed $accountId (required)
    ...
    protected function walletBasicInfoGetRequest($accountId, $walletId = null, $fields = null)
    {
        ...
        $resourcePath = '/wallet_basic_info/get';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
