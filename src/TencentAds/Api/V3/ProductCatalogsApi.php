...
class ProductCatalogsApi
{
    ...
    /**
     * Operation productCatalogsAdd
     *
     * 创建商品库
     *
     * @param  \TencentAds\Model\V3\ProductCatalogsAddRequest|mixed $data data (required)
     *
     * @throws \TencentAds\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \TencentAds\Model\V3\ProductCatalogsAddResponse|mixed
     */
    public function productCatalogsAdd($data)
    {
        list($response) = $this->productCatalogsAddWithHttpInfo($data);
        return $response;
    }

    /**
     * Operation productCatalogsAddWithHttpInfo
     *
     * 创建商品库
     *
     * @param  \TencentAds\Model\V3\ProductCatalogsAddRequest|mixed $data (required)
     *
     * @throws \TencentAds\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \TencentAds\Model\V3\ProductCatalogsAddResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function productCatalogsAddWithHttpInfo($data)
    {
        $returnType = '\TencentAds\Model\V3\ProductCatalogsAddResponse';
        $request = $this->productCatalogsAddRequest($data);
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\TencentAds\Model\V3\ProductCatalogsAddResponse',
    ...
    /**
     * Operation productCatalogsAddAsync
     *
     * 创建商品库
     *
     * @param  \TencentAds\Model\V3\ProductCatalogsAddRequest|mixed $data (required)
     ...
     */
    public function productCatalogsAddAsync($data)
    {
        return $this->productCatalogsAddAsyncWithHttpInfo($data)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation productCatalogsAddAsyncWithHttpInfo
     *
     * 创建商品库
     *
     * @param  \TencentAds\Model\V3\ProductCatalogsAddRequest|mixed $data (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function productCatalogsAddAsyncWithHttpInfo($data)
    {
        $returnType = '\TencentAds\Model\V3\ProductCatalogsAddResponse';
        $request = $this->productCatalogsAddRequest($data);
     ...
     */
    protected function productCatalogsAddRequest($data)
    {
        // verify the required parameter 'data' is set
        if ($data === null || (is_array($data) && count($data) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $data when calling productCatalogsAdd'
            );
        }

        $resourcePath = '/product_catalogs/add';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @throws \TencentAds\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \TencentAds\Model\V3\ProductCatalogsGetResponse|mixed
     */
     ...
     * @throws \TencentAds\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \TencentAds\Model\V3\ProductCatalogsGetResponse, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    {
        $returnType = '\TencentAds\Model\V3\ProductCatalogsGetResponse';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\TencentAds\Model\V3\ProductCatalogsGetResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    protected function productCatalogsGetRequest($accountId, $catalogId = null, $catalogName = null, $page = null, $pageSize = null, $fields = null)
    {
        ...
        if ($accountId === null || (is_array($accountId) && count($accountId) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $accountId when calling productCatalogsGet'
            );
        }

        $resourcePath = '/product_catalogs/get';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
