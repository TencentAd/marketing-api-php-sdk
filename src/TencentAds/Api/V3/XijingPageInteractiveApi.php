...
class XijingPageInteractiveApi
{
     ...
     * @return \TencentAds\Model\V3\XijingPageInteractiveAddResponse|mixed
     */
     ...
     * @throws \TencentAds\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \TencentAds\Model\V3\XijingPageInteractiveAddResponse, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    {
        $returnType = '\TencentAds\Model\V3\XijingPageInteractiveAddResponse';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\TencentAds\Model\V3\XijingPageInteractiveAddResponse',
