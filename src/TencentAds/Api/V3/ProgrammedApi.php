...
class ProgrammedApi
{
     ...
     * 创建模板预览接口
     *
     * @param  \TencentAds\Model\V3\ProgrammedAddRequest|mixed $data data (required)
     *
     * @throws \TencentAds\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \TencentAds\Model\V3\ProgrammedAddResponse|mixed
     */
     ...
     * 创建模板预览接口
     *
     * @param  \TencentAds\Model\V3\ProgrammedAddRequest|mixed $data (required)
     *
     * @throws \TencentAds\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \TencentAds\Model\V3\ProgrammedAddResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function programmedAddWithHttpInfo($data)
    {
        $returnType = '\TencentAds\Model\V3\ProgrammedAddResponse';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\TencentAds\Model\V3\ProgrammedAddResponse',
     ...
     * 获取模板预览接口
     *
     * @param  \TencentAds\Model\V3\ProgrammedGetRequest|mixed $data data (required)
     *
     * @throws \TencentAds\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \TencentAds\Model\V3\ProgrammedGetResponse|mixed
     */
     ...
     * 获取模板预览接口
     *
     * @param  \TencentAds\Model\V3\ProgrammedGetRequest|mixed $data (required)
     *
     * @throws \TencentAds\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \TencentAds\Model\V3\ProgrammedGetResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function programmedGetWithHttpInfo($data)
    {
        $returnType = '\TencentAds\Model\V3\ProgrammedGetResponse';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\TencentAds\Model\V3\ProgrammedGetResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * 更新模板预览接口
     *
     * @param  \TencentAds\Model\V3\ProgrammedUpdateRequest|mixed $data data (required)
     *
     * @throws \TencentAds\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \TencentAds\Model\V3\ProgrammedUpdateResponse|mixed
     */
     ...
     * 更新模板预览接口
     *
     * @param  \TencentAds\Model\V3\ProgrammedUpdateRequest|mixed $data (required)
     *
     * @throws \TencentAds\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \TencentAds\Model\V3\ProgrammedUpdateResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function programmedUpdateWithHttpInfo($data)
    {
        $returnType = '\TencentAds\Model\V3\ProgrammedUpdateResponse';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\TencentAds\Model\V3\ProgrammedUpdateResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
