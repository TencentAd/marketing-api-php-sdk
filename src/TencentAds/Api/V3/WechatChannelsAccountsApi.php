...
/**
 * WechatChannelsAccountsApi Class Doc Comment
 *
 * @category Class
 * @package  TencentAds
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class WechatChannelsAccountsApi
{
    /**
     * @var ClientInterface
     */
    ...
    /**
     * Operation wechatChannelsAccountsGet
     *
     * 获取视频号列表
     *
    ...
    /**
     * Operation wechatChannelsAccountsGetWithHttpInfo
     *
     * 获取视频号列表
     *
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\TencentAds\Model\V3\WechatChannelsAccountsGetResponse',
    ...
    /**
     * Operation wechatChannelsAccountsGetAsync
     *
     * 获取视频号列表
     *
     * @param  int|mixed $accountId (required)
    ...
    /**
     * Operation wechatChannelsAccountsGetAsyncWithHttpInfo
     *
     * 获取视频号列表
     *
     * @param  int|mixed $accountId (required)
    ...
    /**
     * Create request for operation 'wechatChannelsAccountsGet'
     *
     * @param  int|mixed $accountId (required)
     * @param  \TencentAds\Model\V3\FilteringStruct[]|mixed $filtering (optional)
     * @param  int|mixed $page (optional)
    ...
    protected function wechatChannelsAccountsGetRequest($accountId, $filtering = null, $page = null, $pageSize = null, $fields = null)
    {
        ...
        if ($accountId === null || (is_array($accountId) && count($accountId) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $accountId when calling wechatChannelsAccountsGet'
            );
        }

        $resourcePath = '/wechat_channels_accounts/get';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
