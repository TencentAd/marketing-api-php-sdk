...
class VideosApi
{
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\TencentAds\Model\V3\VideosAddResponse',
    ...
    /**
     * Operation videosDelete
     *
     * 删除视频
     *
     * @param  \TencentAds\Model\V3\VideosDeleteRequest|mixed $data data (required)
     *
     * @throws \TencentAds\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \TencentAds\Model\V3\VideosDeleteResponse|mixed
     */
    public function videosDelete($data)
    {
        list($response) = $this->videosDeleteWithHttpInfo($data);
        return $response;
    }

    /**
     * Operation videosDeleteWithHttpInfo
     *
     * 删除视频
     *
     * @param  \TencentAds\Model\V3\VideosDeleteRequest|mixed $data (required)
     *
     * @throws \TencentAds\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \TencentAds\Model\V3\VideosDeleteResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function videosDeleteWithHttpInfo($data)
    {
        $returnType = '\TencentAds\Model\V3\VideosDeleteResponse';
        $request = $this->videosDeleteRequest($data);
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\TencentAds\Model\V3\VideosDeleteResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function videosDeleteAsync($data)
    {
        return $this->videosDeleteAsyncWithHttpInfo($data)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation videosDeleteAsyncWithHttpInfo
     *
     * 删除视频
     *
     * @param  \TencentAds\Model\V3\VideosDeleteRequest|mixed $data (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function videosDeleteAsyncWithHttpInfo($data)
    {
        $returnType = '\TencentAds\Model\V3\VideosDeleteResponse';
        $request = $this->videosDeleteRequest($data);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function videosDeleteRequest($data)
    {
        // verify the required parameter 'data' is set
        if ($data === null || (is_array($data) && count($data) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $data when calling videosDelete'
            );
        }

        $resourcePath = '/videos/delete';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\TencentAds\Model\V3\VideosGetResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * 修改视频信息
     *
     * @param  \TencentAds\Model\V3\VideosUpdateRequest|mixed $data data (required)
     *
     * @throws \TencentAds\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \TencentAds\Model\V3\VideosUpdateResponse|mixed
     */
     ...
     * 修改视频信息
     *
     * @param  \TencentAds\Model\V3\VideosUpdateRequest|mixed $data (required)
     *
     * @throws \TencentAds\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \TencentAds\Model\V3\VideosUpdateResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function videosUpdateWithHttpInfo($data)
    {
        $returnType = '\TencentAds\Model\V3\VideosUpdateResponse';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\TencentAds\Model\V3\VideosUpdateResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
