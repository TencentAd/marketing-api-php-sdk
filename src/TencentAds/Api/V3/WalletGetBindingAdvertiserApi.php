...
/**
 * WalletGetBindingAdvertiserApi Class Doc Comment
 *
 * @category Class
 * @package  TencentAds
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class WalletGetBindingAdvertiserApi
{
    /**
     * @var ClientInterface
     */
    ...
    /**
     * Operation walletGetBindingAdvertiserGet
     *
     * 查询单个共享钱包下的关联账户信息
     *
    ...
    /**
     * Operation walletGetBindingAdvertiserGetWithHttpInfo
     *
     * 查询单个共享钱包下的关联账户信息
     *
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\TencentAds\Model\V3\WalletGetBindingAdvertiserGetResponse',
    ...
    /**
     * Operation walletGetBindingAdvertiserGetAsync
     *
     * 查询单个共享钱包下的关联账户信息
     *
     * @param  int|mixed $accountId (required)
    ...
    /**
     * Operation walletGetBindingAdvertiserGetAsyncWithHttpInfo
     *
     * 查询单个共享钱包下的关联账户信息
     *
     * @param  int|mixed $accountId (required)
    ...
    /**
     * Create request for operation 'walletGetBindingAdvertiserGet'
     *
     * @param  int|mixed $accountId (required)
     * @param  int|mixed $walletId (required)
     * @param  int|mixed $page (required)
    ...
    protected function walletGetBindingAdvertiserGetRequest($accountId, $walletId, $page, $pageSize, $fields = null)
    {
        ...
        if ($accountId === null || (is_array($accountId) && count($accountId) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $accountId when calling walletGetBindingAdvertiserGet'
            );
        }
        ...
        $resourcePath = '/wallet_get_binding_advertiser/get';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
