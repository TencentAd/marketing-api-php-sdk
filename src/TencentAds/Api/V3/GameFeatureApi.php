...
class GameFeatureApi
{
     ...
     * @return \TencentAds\Model\V3\GameFeatureAddResponse|mixed
     */
     ...
     * @throws \TencentAds\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \TencentAds\Model\V3\GameFeatureAddResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function gameFeatureAddWithHttpInfo($data)
    {
        $returnType = '\TencentAds\Model\V3\GameFeatureAddResponse';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\TencentAds\Model\V3\GameFeatureAddResponse',
     ...
     * @throws \TencentAds\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \TencentAds\Model\V3\GameFeatureGetResponse|mixed
     */
    public function gameFeatureGet($accountId, $marketingTargetType, $marketingTargetDetailId, $fields = null)
    {
        list($response) = $this->gameFeatureGetWithHttpInfo($accountId, $marketingTargetType, $marketingTargetDetailId, $fields);
        return $response;
    }
     ...
     * @throws \TencentAds\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \TencentAds\Model\V3\GameFeatureGetResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function gameFeatureGetWithHttpInfo($accountId, $marketingTargetType, $marketingTargetDetailId, $fields = null)
    {
        $returnType = '\TencentAds\Model\V3\GameFeatureGetResponse';
        $request = $this->gameFeatureGetRequest($accountId, $marketingTargetType, $marketingTargetDetailId, $fields);
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\TencentAds\Model\V3\GameFeatureGetResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function gameFeatureGetAsync($accountId, $marketingTargetType, $marketingTargetDetailId, $fields = null)
    {
        return $this->gameFeatureGetAsyncWithHttpInfo($accountId, $marketingTargetType, $marketingTargetDetailId, $fields)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function gameFeatureGetAsyncWithHttpInfo($accountId, $marketingTargetType, $marketingTargetDetailId, $fields = null)
    {
        $returnType = '\TencentAds\Model\V3\GameFeatureGetResponse';
        $request = $this->gameFeatureGetRequest($accountId, $marketingTargetType, $marketingTargetDetailId, $fields);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function gameFeatureGetRequest($accountId, $marketingTargetType, $marketingTargetDetailId, $fields = null)
    {
        ...
        if ($marketingTargetType === null || (is_array($marketingTargetType) && count($marketingTargetType) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $marketingTargetType when calling gameFeatureGet'
            );
        }
        ...
        if ($marketingTargetDetailId === null || (is_array($marketingTargetDetailId) && count($marketingTargetDetailId) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $marketingTargetDetailId when calling gameFeatureGet'
            );
        }
