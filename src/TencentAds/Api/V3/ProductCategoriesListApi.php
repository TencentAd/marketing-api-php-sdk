...
/**
 * ProductCategoriesListApi Class Doc Comment
 *
 * @category Class
 * @package  TencentAds
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ProductCategoriesListApi
{
    /**
     * @var ClientInterface
     */
    ...
    /**
     * Operation productCategoriesListGet
     *
     * 获取商品类目
     *
     ...
     * @return \TencentAds\Model\V3\ProductCategoriesListGetResponse|mixed
     */
    ...
    /**
     * Operation productCategoriesListGetWithHttpInfo
     *
     * 获取商品类目
     *
     ...
     * @throws \TencentAds\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \TencentAds\Model\V3\ProductCategoriesListGetResponse, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    {
        $returnType = '\TencentAds\Model\V3\ProductCategoriesListGetResponse';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\TencentAds\Model\V3\ProductCategoriesListGetResponse',
    ...
    /**
     * Operation productCategoriesListGetAsync
     *
     * 获取商品类目
     *
     * @param  int|mixed $accountId (required)
    ...
    /**
     * Operation productCategoriesListGetAsyncWithHttpInfo
     *
     * 获取商品类目
     *
     * @param  int|mixed $accountId (required)
    ...
    protected function productCategoriesListGetRequest($accountId, $productCatalogId, $page, $pageSize, $level = null, $categoryId = null, $categoryName = null, $fields = null)
    {
        ...
        if ($accountId === null || (is_array($accountId) && count($accountId) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $accountId when calling productCategoriesListGet'
            );
        }
        ...
        $resourcePath = '/product_categories_list/get';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
