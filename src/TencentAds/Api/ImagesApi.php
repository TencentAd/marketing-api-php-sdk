...
class ImagesApi
{
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\TencentAds\Model\ImagesAddResponse',
    ...
    protected function imagesAddRequest($accountId, $uploadType, $signature, $file = null, $bytes = null, $imageUsage = null, $description = null, $resizeWidth = null, $resizeHeight = null, $resizeFileSize = null)
    {
        ...
        if ($signature === null || (is_array($signature) && count($signature) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $signature when calling imagesAdd'
            );
        }
     ...
     * @throws \TencentAds\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \TencentAds\Model\ImagesDeleteResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function imagesDeleteWithHttpInfo($data)
    {
        $returnType = '\TencentAds\Model\ImagesDeleteResponse';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\TencentAds\Model\ImagesDeleteResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    {
        list($response) = $this->imagesGetWithHttpInfo($accountId, $filtering, $page, $pageSize, $fields);
        return $response;
    }
     ...
     * @throws \TencentAds\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \TencentAds\Model\ImagesGetResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function imagesGetWithHttpInfo($accountId, $filtering = null, $page = null, $pageSize = null, $fields = null)
    {
        $returnType = '\TencentAds\Model\ImagesGetResponse';
        $request = $this->imagesGetRequest($accountId, $filtering, $page, $pageSize, $fields);
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\TencentAds\Model\ImagesGetResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function imagesGetAsync($accountId, $filtering = null, $page = null, $pageSize = null, $fields = null)
    {
        return $this->imagesGetAsyncWithHttpInfo($accountId, $filtering, $page, $pageSize, $fields)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function imagesGetAsyncWithHttpInfo($accountId, $filtering = null, $page = null, $pageSize = null, $fields = null)
    {
        $returnType = '\TencentAds\Model\ImagesGetResponse';
        $request = $this->imagesGetRequest($accountId, $filtering, $page, $pageSize, $fields);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function imagesGetRequest($accountId, $filtering = null, $page = null, $pageSize = null, $fields = null)
    {
        // verify the required parameter 'accountId' is set
        if ($accountId === null || (is_array($accountId) && count($accountId) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @throws \TencentAds\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \TencentAds\Model\ImagesUpdateResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function imagesUpdateWithHttpInfo($data)
    {
        $returnType = '\TencentAds\Model\ImagesUpdateResponse';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\TencentAds\Model\ImagesUpdateResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
