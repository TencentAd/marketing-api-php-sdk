...
class ExtendPackageApi
{
     ...
     * 创建应用分包
     *
     * @param  \TencentAds\Model\ExtendPackageAddRequest|mixed $data data (required)
     *
     * @throws \TencentAds\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \TencentAds\Model\ExtendPackageAddResponse|mixed
     */
     ...
     * 创建应用分包
     *
     * @param  \TencentAds\Model\ExtendPackageAddRequest|mixed $data (required)
     *
     * @throws \TencentAds\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \TencentAds\Model\ExtendPackageAddResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function extendPackageAddWithHttpInfo($data)
    {
        $returnType = '\TencentAds\Model\ExtendPackageAddResponse';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\TencentAds\Model\ExtendPackageAddResponse',
     ...
     * @throws \TencentAds\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \TencentAds\Model\ExtendPackageGetResponse|mixed
     */
     ...
     * @throws \TencentAds\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \TencentAds\Model\ExtendPackageGetResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function extendPackageGetWithHttpInfo($accountId, $packageId, $filtering = null, $page = null, $pageSize = null, $fields = null)
    {
        $returnType = '\TencentAds\Model\ExtendPackageGetResponse';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\TencentAds\Model\ExtendPackageGetResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * 更新应用子包版本
     *
     * @param  \TencentAds\Model\ExtendPackageUpdateRequest|mixed $data data (required)
     *
     * @throws \TencentAds\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \TencentAds\Model\ExtendPackageUpdateResponse|mixed
     */
     ...
     * 更新应用子包版本
     *
     * @param  \TencentAds\Model\ExtendPackageUpdateRequest|mixed $data (required)
     *
     * @throws \TencentAds\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \TencentAds\Model\ExtendPackageUpdateResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function extendPackageUpdateWithHttpInfo($data)
    {
        $returnType = '\TencentAds\Model\ExtendPackageUpdateResponse';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\TencentAds\Model\ExtendPackageUpdateResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
