...
class WechatFundStatementsDetailedApi
{
     ...
     * 获取微信资金账户流水信息
     *
     * @param  string $tradeType 交易类型 (required)
     * @param  map[string,string] $dateRange 日期范围 (required)
     * @param  \TencentAds\Model\WechatFundStatementsDetailedGetFilteringStruct[] $filtering 过滤条件 (optional)
     ...
     * @return \TencentAds\Model\WechatFundStatementsDetailedList
     */
     ...
     * @throws \TencentAds\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \TencentAds\Model\WechatFundStatementsDetailedList, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    {
        $returnType = '\TencentAds\Model\WechatFundStatementsDetailedList';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\TencentAds\Model\WechatFundStatementsDetailedList',
