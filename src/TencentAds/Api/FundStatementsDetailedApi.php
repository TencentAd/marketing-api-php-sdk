...
class FundStatementsDetailedApi
{
     ...
     * @param  string $fundType 资金账户类型 (required)
     * @param  map[string,string] $dateRange 日期范围 (required)
     * @param  int $page 按日期范围的总天数进行分页，每天一页 (optional)
     * @param  int $pageSize 每天固定返回 4 条记录（充值、消费、过期和回划） (optional)
     * @param  string[] $fields 返回参数的字段列表 (optional)
     *
     * @throws \TencentAds\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \TencentAds\Model\FundStatementsDetailedList
     */
     ...
     * @throws \TencentAds\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \TencentAds\Model\FundStatementsDetailedList, HTTP status code, HTTP response headers (array of strings)
     */
    public function fundStatementsDetailedGetWithHttpInfo($accountId, $fundType, $dateRange, $page = null, $pageSize = null, $fields = null)
    {
        $returnType = '\TencentAds\Model\FundStatementsDetailedList';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\TencentAds\Model\FundStatementsDetailedList',
    ...
    protected function fundStatementsDetailedGetRequest($accountId, $fundType, $dateRange, $page = null, $pageSize = null, $fields = null)
    {
        ...
        if ($accountId === null || (is_array($accountId) && count($accountId) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $accountId when calling fundStatementsDetailedGet'
            );
        }
