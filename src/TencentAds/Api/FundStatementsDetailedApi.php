...
class FundStatementsDetailedApi
{
     ...
     * @throws \TencentAds\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \TencentAds\Model\FundStatementsDetailedGetResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function fundStatementsDetailedGetWithHttpInfo($accountId, $fundType, $dateRange, $page = null, $pageSize = null, $fields = null)
    {
        $returnType = '\TencentAds\Model\FundStatementsDetailedGetResponse';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\TencentAds\Model\FundStatementsDetailedGetResponse',
