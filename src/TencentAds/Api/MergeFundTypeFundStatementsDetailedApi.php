<?php
/**
 * MergeFundTypeFundStatementsDetailedApi
 * PHP version 5
 *
 * @category Class
 * @package  TencentAds
...
/**
 * MergeFundTypeFundStatementsDetailedApi Class Doc Comment
 *
 * @category Class
 * @package  TencentAds
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class MergeFundTypeFundStatementsDetailedApi
{
    /**
     * @var ClientInterface
     */
    ...
    /**
     * Operation mergeFundTypeFundStatementsDetailedGet
     *
     * 获取资金合并类型资金流水
     *
     ...
     * @return \TencentAds\Model\MergeFundTypeFundStatementsDetailedGetResponse|mixed
     */
    ...
    /**
     * Operation mergeFundTypeFundStatementsDetailedGetWithHttpInfo
     *
     * 获取资金合并类型资金流水
     *
     ...
     * @throws \TencentAds\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \TencentAds\Model\MergeFundTypeFundStatementsDetailedGetResponse, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    {
        $returnType = '\TencentAds\Model\MergeFundTypeFundStatementsDetailedGetResponse';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\TencentAds\Model\MergeFundTypeFundStatementsDetailedGetResponse',
    ...
    /**
     * Operation mergeFundTypeFundStatementsDetailedGetAsync
     *
     * 获取资金合并类型资金流水
     *
     * @param  int|mixed $accountId (required)
    ...
    /**
     * Operation mergeFundTypeFundStatementsDetailedGetAsyncWithHttpInfo
     *
     * 获取资金合并类型资金流水
     *
     * @param  int|mixed $accountId (required)
    ...
    protected function mergeFundTypeFundStatementsDetailedGetRequest($accountId, $fundType, $dateRange, $page = null, $pageSize = null, $fields = null)
    {
        ...
        if ($fundType === null || (is_array($fundType) && count($fundType) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $fundType when calling mergeFundTypeFundStatementsDetailedGet'
            );
        }
        // verify the required parameter 'dateRange' is set
        if ($dateRange === null || (is_array($dateRange) && count($dateRange) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $dateRange when calling mergeFundTypeFundStatementsDetailedGet'
            );
        }

        $resourcePath = '/merge_fund_type_fund_statements_detailed/get';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
