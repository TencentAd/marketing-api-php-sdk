...
class GameFeatureTagsApi
{
     ...
     * @return \TencentAds\Model\GameFeatureTagsGetResponse|mixed
     */
     ...
     * @throws \TencentAds\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \TencentAds\Model\GameFeatureTagsGetResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function gameFeatureTagsGetWithHttpInfo($accountId, $type, $fields = null)
    {
        $returnType = '\TencentAds\Model\GameFeatureTagsGetResponse';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\TencentAds\Model\GameFeatureTagsGetResponse',
