...
class DataSourceApi
{
    ...
    /**
     * Operation dataSourceAdd
     *
     * 添加数据源
     *
     * @param  \TencentAds\Model\DataSourceAddRequest|mixed $data data (required)
     *
     * @throws \TencentAds\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \TencentAds\Model\DataSourceAddResponse|mixed
     */
    public function dataSourceAdd($data)
    {
        list($response) = $this->dataSourceAddWithHttpInfo($data);
        return $response;
    }

    /**
     * Operation dataSourceAddWithHttpInfo
     *
     * 添加数据源
     *
     * @param  \TencentAds\Model\DataSourceAddRequest|mixed $data (required)
     *
     * @throws \TencentAds\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \TencentAds\Model\DataSourceAddResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function dataSourceAddWithHttpInfo($data)
    {
        $returnType = '\TencentAds\Model\DataSourceAddResponse';
        $request = $this->dataSourceAddRequest($data);
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\TencentAds\Model\DataSourceAddResponse',
     ...
     */
    public function dataSourceAddAsync($data)
    {
        return $this->dataSourceAddAsyncWithHttpInfo($data)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation dataSourceAddAsyncWithHttpInfo
     *
     * 添加数据源
     *
     * @param  \TencentAds\Model\DataSourceAddRequest|mixed $data (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function dataSourceAddAsyncWithHttpInfo($data)
    {
        $returnType = '\TencentAds\Model\DataSourceAddResponse';
        $request = $this->dataSourceAddRequest($data);
    ...
    /**
     * Create request for operation 'dataSourceAdd'
     *
     * @param  \TencentAds\Model\DataSourceAddRequest|mixed $data (required)
     *
     * @throws \InvalidArgumentException
     ...
     */
    protected function dataSourceAddRequest($data)
    {
        // verify the required parameter 'data' is set
        if ($data === null || (is_array($data) && count($data) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $data when calling dataSourceAdd'
            );
        }

        $resourcePath = '/data_source/add';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\TencentAds\Model\DataSourceGetResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
