...
class ProductCatalogsApi
{
     ...
     * @throws \TencentAds\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \TencentAds\Model\ProductCatalogsAddResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function productCatalogsAddWithHttpInfo($data)
    {
        $returnType = '\TencentAds\Model\ProductCatalogsAddResponse';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\TencentAds\Model\ProductCatalogsAddResponse',
     ...
     * @throws \TencentAds\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \TencentAds\Model\ProductCatalogsList
     */
     ...
     * @throws \TencentAds\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \TencentAds\Model\ProductCatalogsList, HTTP status code, HTTP response headers (array of strings)
     */
    public function productCatalogsGetWithHttpInfo($accountId, $page = null, $pageSize = null, $fields = null)
    {
        $returnType = '\TencentAds\Model\ProductCatalogsList';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\TencentAds\Model\ProductCatalogsList',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
