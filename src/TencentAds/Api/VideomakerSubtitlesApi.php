...
/**
 * VideomakerSubtitlesApi Class Doc Comment
 *
 * @category Class
 * @package  TencentAds
 * @author   Swagger Codegen team
...
class VideomakerSubtitlesApi
{
    ...
    /**
     * Operation videomakerSubtitlesAdd
     *
     * 创建视频加字幕任务
     *
    ...
    /**
     * Operation videomakerSubtitlesAddWithHttpInfo
     *
     * 创建视频加字幕任务
     *
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\TencentAds\Model\VideomakerSubtitlesAddResponse',
    ...
    /**
     * Operation videomakerSubtitlesAddAsync
     *
     * 创建视频加字幕任务
     *
     * @param  int $accountId (required)
    ...
    /**
     * Operation videomakerSubtitlesAddAsyncWithHttpInfo
     *
     * 创建视频加字幕任务
     *
     * @param  int $accountId (required)
    ...
    protected function videomakerSubtitlesAddRequest($accountId, $videoId = null, $videoFile = null, $signature = null, $onlySubtitleFile = null)
    {
        ...
        if ($accountId === null || (is_array($accountId) && count($accountId) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $accountId when calling videomakerSubtitlesAdd'
            );
        }

        $resourcePath = '/videomaker_subtitles/add';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
