...
class VideosApi
{
     ...
     * @param  \SplFileObject $videoFile 被上传的视频文件 (required)
     * @param  string $signature 视频文件签名 (required)
     * @param  string $description 视频文件描述 (optional)
     * @param  int $adcreativeTemplateId 创意规格ID (optional)
     *
     ...
     * @param  \TencentAds\Model\MediaFilteringStruct[] $filtering 过滤条件 (optional)
     ...
     * @throws \TencentAds\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \TencentAds\Model\VideosList
     */
     ...
     * @throws \TencentAds\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \TencentAds\Model\VideosList, HTTP status code, HTTP response headers (array of strings)
     */
    public function videosGetWithHttpInfo($accountId, $filtering = null, $page = null, $pageSize = null, $fields = null)
    {
        $returnType = '\TencentAds\Model\VideosList';
