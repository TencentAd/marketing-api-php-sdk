...
class VideosApi
{
     ...
     * @throws \TencentAds\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \TencentAds\Model\VideosDeleteResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function videosDeleteWithHttpInfo($data)
    {
        $returnType = '\TencentAds\Model\VideosDeleteResponse';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\TencentAds\Model\VideosDeleteResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
