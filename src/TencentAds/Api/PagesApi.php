...
class PagesApi
{
     ...
     * @param  \TencentAds\Model\LandingPageFilteringStruct[] $filtering 过滤条件 (optional)
     ...
     * @return \TencentAds\Model\PagesList
     */
     ...
     * @throws \TencentAds\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \TencentAds\Model\PagesList, HTTP status code, HTTP response headers (array of strings)
     */
    public function pagesGetWithHttpInfo($accountId, $promotedObjectType, $filtering = null, $page = null, $pageSize = null, $fields = null)
    {
        $returnType = '\TencentAds\Model\PagesList';
