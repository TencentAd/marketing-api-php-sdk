...
class ReportApi
{
    ...
    /**
     * Operation reportAdUnion
     *
     * 联盟广告位报表接口
     *
     * @param  \TencentAds\Model\ReportAdUnionRequest|mixed $data data (required)
     *
     * @throws \TencentAds\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \TencentAds\Model\ReportAdUnionResponse|mixed
     */
    public function reportAdUnion($data)
    {
        list($response) = $this->reportAdUnionWithHttpInfo($data);
        return $response;
    }

    /**
     * Operation reportAdUnionWithHttpInfo
     *
     * 联盟广告位报表接口
     *
     * @param  \TencentAds\Model\ReportAdUnionRequest|mixed $data (required)
     *
     * @throws \TencentAds\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \TencentAds\Model\ReportAdUnionResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function reportAdUnionWithHttpInfo($data)
    {
        $returnType = '\TencentAds\Model\ReportAdUnionResponse';
        $request = $this->reportAdUnionRequest($data);
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\TencentAds\Model\ReportAdUnionResponse',
     ...
     */
    public function reportAdUnionAsync($data)
    {
        return $this->reportAdUnionAsyncWithHttpInfo($data)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation reportAdUnionAsyncWithHttpInfo
     *
     * 联盟广告位报表接口
     *
     * @param  \TencentAds\Model\ReportAdUnionRequest|mixed $data (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function reportAdUnionAsyncWithHttpInfo($data)
    {
        $returnType = '\TencentAds\Model\ReportAdUnionResponse';
        $request = $this->reportAdUnionRequest($data);
    ...
    /**
     * Create request for operation 'reportAdUnion'
     *
     * @param  \TencentAds\Model\ReportAdUnionRequest|mixed $data (required)
     *
     * @throws \InvalidArgumentException
     ...
     */
    protected function reportAdUnionRequest($data)
    {
        // verify the required parameter 'data' is set
        if ($data === null || (is_array($data) && count($data) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $data when calling reportAdUnion'
            );
        }

        $resourcePath = '/report/ad_union';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation reportLandingPage
     *
     * 落地页报表数据接口
     *
     * @param  \TencentAds\Model\ReportLandingPageRequest|mixed $data data (required)
     *
     * @throws \TencentAds\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \TencentAds\Model\ReportLandingPageResponse|mixed
     */
    public function reportLandingPage($data)
    {
        list($response) = $this->reportLandingPageWithHttpInfo($data);
        return $response;
    }

    /**
     * Operation reportLandingPageWithHttpInfo
     *
     * 落地页报表数据接口
     *
     * @param  \TencentAds\Model\ReportLandingPageRequest|mixed $data (required)
     *
     * @throws \TencentAds\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \TencentAds\Model\ReportLandingPageResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function reportLandingPageWithHttpInfo($data)
    {
        $returnType = '\TencentAds\Model\ReportLandingPageResponse';
        $request = $this->reportLandingPageRequest($data);
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\TencentAds\Model\ReportLandingPageResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    /**
     * Operation reportLandingPageAsync
     *
     * 落地页报表数据接口
     *
     * @param  \TencentAds\Model\ReportLandingPageRequest|mixed $data (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function reportLandingPageAsync($data)
    {
        return $this->reportLandingPageAsyncWithHttpInfo($data)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation reportLandingPageAsyncWithHttpInfo
     *
     * 落地页报表数据接口
     *
     * @param  \TencentAds\Model\ReportLandingPageRequest|mixed $data (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function reportLandingPageAsyncWithHttpInfo($data)
    {
        $returnType = '\TencentAds\Model\ReportLandingPageResponse';
        $request = $this->reportLandingPageRequest($data);
    ...
    /**
     * Create request for operation 'reportLandingPage'
     *
     * @param  \TencentAds\Model\ReportLandingPageRequest|mixed $data (required)
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function reportLandingPageRequest($data)
    {
        // verify the required parameter 'data' is set
        if ($data === null || (is_array($data) && count($data) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $data when calling reportLandingPage'
            );
        }

        $resourcePath = '/report/landing_page';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
