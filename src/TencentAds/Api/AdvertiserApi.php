...
class AdvertiserApi
{
     ...
     * @param  \TencentAds\Model\AgencyFilteringStruct[] $filtering 过滤条件 (optional)
     ...
     * @throws \TencentAds\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \TencentAds\Model\AdvertiserList
     */
     ...
     * @throws \TencentAds\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \TencentAds\Model\AdvertiserList, HTTP status code, HTTP response headers (array of strings)
     */
    public function advertiserGetWithHttpInfo($accountId = null, $filtering = null, $page = null, $pageSize = null, $fields = null)
    {
        $returnType = '\TencentAds\Model\AdvertiserList';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\TencentAds\Model\AdvertiserList',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
