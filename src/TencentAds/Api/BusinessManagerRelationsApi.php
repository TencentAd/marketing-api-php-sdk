...
/**
 * BusinessManagerRelationsApi Class Doc Comment
 *
 * @category Class
 * @package  TencentAds
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class BusinessManagerRelationsApi
{
    /**
     * @var ClientInterface
     */
     ...
     * @return \TencentAds\Model\BusinessManagerRelationsList
     */
     ...
     * @throws \TencentAds\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \TencentAds\Model\BusinessManagerRelationsList, HTTP status code, HTTP response headers (array of strings)
     */
    public function businessManagerRelationsGetWithHttpInfo($page = null, $pageSize = null, $fields = null)
    {
        $returnType = '\TencentAds\Model\BusinessManagerRelationsList';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\TencentAds\Model\BusinessManagerRelationsList',
    ...
    /**
     * Create request for operation 'businessManagerRelationsGet'
     *
     * @param  int $page 搜索页码，默认值：1 (optional)
     * @param  int $pageSize 一页显示的数据条数，默认值：10 (optional)
     * @param  string[] $fields 返回参数的字段列表 (optional)
