...
class DailyReportsApi
{
     ...
     * @param  \TencentAds\Model\DailyReportsGetFilteringStruct[] $filtering 过滤条件 (optional)
     ...
     * @return \TencentAds\Model\DailyReportsList
     */
     ...
     * @throws \TencentAds\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \TencentAds\Model\DailyReportsList, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    {
        $returnType = '\TencentAds\Model\DailyReportsList';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\TencentAds\Model\DailyReportsList',
