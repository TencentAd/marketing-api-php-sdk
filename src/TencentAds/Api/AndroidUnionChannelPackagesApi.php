<?php
/**
 * AndroidUnionChannelPackagesApi
 * PHP version 5
 *
 * @category Class
 * @package  TencentAds
...
/**
 * AndroidUnionChannelPackagesApi Class Doc Comment
 *
 * @category Class
 * @package  TencentAds
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class AndroidUnionChannelPackagesApi
{
    /**
     * @var ClientInterface
     */
    ...
    /**
     * Operation androidUnionChannelPackagesAdd
     *
     * 添加广告渠道包
     *
    ...
    {
        list($response) = $this->androidUnionChannelPackagesAddWithHttpInfo($data);
        return $response;
    }

    /**
     * Operation androidUnionChannelPackagesAddWithHttpInfo
     *
     * 添加广告渠道包
     *
     ...
     * @throws \TencentAds\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \TencentAds\Model\AndroidUnionChannelPackagesAddResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function androidUnionChannelPackagesAddWithHttpInfo($data)
    {
        $returnType = '\TencentAds\Model\AndroidUnionChannelPackagesAddResponse';
        $request = $this->androidUnionChannelPackagesAddRequest($data);
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\TencentAds\Model\AndroidUnionChannelPackagesAddResponse',
    ...
    /**
     * Operation androidUnionChannelPackagesAddAsync
     *
     * 添加广告渠道包
     *
     * @param  \TencentAds\Model\AndroidUnionChannelPackagesAddRequest $data (required)
     ...
     */
    public function androidUnionChannelPackagesAddAsync($data)
    {
        return $this->androidUnionChannelPackagesAddAsyncWithHttpInfo($data)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation androidUnionChannelPackagesAddAsyncWithHttpInfo
     *
     * 添加广告渠道包
     *
     * @param  \TencentAds\Model\AndroidUnionChannelPackagesAddRequest $data (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function androidUnionChannelPackagesAddAsyncWithHttpInfo($data)
    {
        $returnType = '\TencentAds\Model\AndroidUnionChannelPackagesAddResponse';
        $request = $this->androidUnionChannelPackagesAddRequest($data);
     ...
     */
    protected function androidUnionChannelPackagesAddRequest($data)
    {
        // verify the required parameter 'data' is set
        if ($data === null || (is_array($data) && count($data) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $data when calling androidUnionChannelPackagesAdd'
            );
        }

        $resourcePath = '/android_union_channel_packages/add';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation androidUnionChannelPackagesGet
     *
     * 获取广告渠道包
     *
    ...
    /**
     * Operation androidUnionChannelPackagesGetWithHttpInfo
     *
     * 获取广告渠道包
     *
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\TencentAds\Model\AndroidUnionChannelPackagesGetResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    /**
     * Operation androidUnionChannelPackagesGetAsync
     *
     * 获取广告渠道包
     *
     * @param  int $accountId (required)
    ...
    /**
     * Operation androidUnionChannelPackagesGetAsyncWithHttpInfo
     *
     * 获取广告渠道包
     *
     * @param  int $accountId (required)
    ...
    protected function androidUnionChannelPackagesGetRequest($accountId, $androidUnionAppId, $filtering = null, $page = null, $pageSize = null, $fields = null)
    {
        ...
        if ($accountId === null || (is_array($accountId) && count($accountId) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $accountId when calling androidUnionChannelPackagesGet'
            );
        }
        // verify the required parameter 'androidUnionAppId' is set
        if ($androidUnionAppId === null || (is_array($androidUnionAppId) && count($androidUnionAppId) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $androidUnionAppId when calling androidUnionChannelPackagesGet'
            );
        }

        $resourcePath = '/android_union_channel_packages/get';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation androidUnionChannelPackagesUpdate
     *
     * 更新广告渠道包
     *
    ...
    {
        list($response) = $this->androidUnionChannelPackagesUpdateWithHttpInfo($data);
        return $response;
    }

    /**
     * Operation androidUnionChannelPackagesUpdateWithHttpInfo
     *
     * 更新广告渠道包
     *
     ...
     * @throws \TencentAds\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \TencentAds\Model\AndroidUnionChannelPackagesUpdateResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function androidUnionChannelPackagesUpdateWithHttpInfo($data)
    {
        $returnType = '\TencentAds\Model\AndroidUnionChannelPackagesUpdateResponse';
        $request = $this->androidUnionChannelPackagesUpdateRequest($data);
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\TencentAds\Model\AndroidUnionChannelPackagesUpdateResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    /**
     * Operation androidUnionChannelPackagesUpdateAsync
     *
     * 更新广告渠道包
     *
     * @param  \TencentAds\Model\AndroidUnionChannelPackagesUpdateRequest $data (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function androidUnionChannelPackagesUpdateAsync($data)
    {
        return $this->androidUnionChannelPackagesUpdateAsyncWithHttpInfo($data)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation androidUnionChannelPackagesUpdateAsyncWithHttpInfo
     *
     * 更新广告渠道包
     *
     * @param  \TencentAds\Model\AndroidUnionChannelPackagesUpdateRequest $data (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function androidUnionChannelPackagesUpdateAsyncWithHttpInfo($data)
    {
        $returnType = '\TencentAds\Model\AndroidUnionChannelPackagesUpdateResponse';
        $request = $this->androidUnionChannelPackagesUpdateRequest($data);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function androidUnionChannelPackagesUpdateRequest($data)
    {
        // verify the required parameter 'data' is set
        if ($data === null || (is_array($data) && count($data) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $data when calling androidUnionChannelPackagesUpdate'
            );
        }

        $resourcePath = '/android_union_channel_packages/update';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
