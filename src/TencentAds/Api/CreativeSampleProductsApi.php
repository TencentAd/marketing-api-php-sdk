...
/**
 * CreativeSampleProductsApi Class Doc Comment
 *
 * @category Class
 * @package  TencentAds
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CreativeSampleProductsApi
{
    /**
     * @var ClientInterface
     */
    ...
    /**
     * Operation creativeSampleProductsGet
     *
     * 获取创意示例商品列表
     *
    ...
    /**
     * Operation creativeSampleProductsGetWithHttpInfo
     *
     * 获取创意示例商品列表
     *
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\TencentAds\Model\CreativeSampleProductsGetResponse',
    ...
    /**
     * Operation creativeSampleProductsGetAsync
     *
     * 获取创意示例商品列表
     *
     * @param  \TencentAds\Model\CreativeSampleProductsGetRequest|mixed $data (required)
    ...
    /**
     * Operation creativeSampleProductsGetAsyncWithHttpInfo
     *
     * 获取创意示例商品列表
     *
     * @param  \TencentAds\Model\CreativeSampleProductsGetRequest|mixed $data (required)
    ...
    protected function creativeSampleProductsGetRequest($data)
    {
        ...
        $resourcePath = '/creative_sample_products/get';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
