...
class ProfilesApi
{
     ...
     * @param  \TencentAds\Model\ProfileFilteringStruct[] $filtering 过滤条件 (optional)
     ...
     * @throws \TencentAds\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \TencentAds\Model\ProfilesList
     */
     ...
     * @throws \TencentAds\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \TencentAds\Model\ProfilesList, HTTP status code, HTTP response headers (array of strings)
     */
    public function profilesGetWithHttpInfo($accountId, $filtering = null, $page = null, $pageSize = null, $fields = null)
    {
        $returnType = '\TencentAds\Model\ProfilesList';
