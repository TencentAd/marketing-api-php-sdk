...
class ProfilesApi
{
     ...
     * 创建朋友圈头像昵称跳转页
     *
     * @param  \TencentAds\Model\ProfilesAddRequest|mixed $data data (required)
     *
     ...
     * 创建朋友圈头像昵称跳转页
     *
     * @param  \TencentAds\Model\ProfilesAddRequest|mixed $data (required)
     *
     * @throws \TencentAds\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     * 删除朋友圈头像昵称跳转页
     *
     * @param  \TencentAds\Model\ProfilesDeleteRequest|mixed $data data (required)
     *
     * @throws \TencentAds\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     * 删除朋友圈头像昵称跳转页
     *
     * @param  \TencentAds\Model\ProfilesDeleteRequest|mixed $data (required)
     *
     * @throws \TencentAds\ApiException on non-2xx response
     * @throws \InvalidArgumentException
