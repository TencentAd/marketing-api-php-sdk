...
/**
 * AsyncReportFilesApi Class Doc Comment
 *
 * @category Class
 * @package  TencentAds
 * @author   Swagger Codegen team
...
class AsyncReportFilesApi
{
    ...
    /**
     * Operation asyncReportFilesGetWithHttpInfo
     *
     * 获取文件接口
     *
    ...
    /**
     * Operation asyncReportFilesGetAsync
     *
     * 获取文件接口
     *
     * @param  int $accountId (required)
    ...
    /**
     * Operation asyncReportFilesGetAsyncWithHttpInfo
     *
     * 获取文件接口
     *
     * @param  int $accountId (required)
    ...
    protected function asyncReportFilesGetRequest($accountId, $taskId, $fileId, $fields = null)
    {
        ...
        if ($taskId === null || (is_array($taskId) && count($taskId) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $taskId when calling asyncReportFilesGet'
            );
        }
        // verify the required parameter 'fileId' is set
        if ($fileId === null || (is_array($fileId) && count($fileId) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $fileId when calling asyncReportFilesGet'
            );
        }

        $resourcePath = '/async_report_files/get';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
