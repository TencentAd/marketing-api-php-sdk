...
/**
 * DynamicAdTemplatesList Class Doc Comment
 *
 * @category Class
 * @package  TencentAds
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class DynamicAdTemplatesList implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'DynamicAdTemplatesList';
    ...
    protected static $swaggerTypes = [
        ...
        'message' => 'string',
        'messageCn' => 'string',
        'data' => '\TencentAds\Model\DynamicAdTemplatesListData'
    ];
     ...
     * Sets data
     *
     * @param \TencentAds\Model\DynamicAdTemplatesListData $data data
     *
     * @return $this
     */
