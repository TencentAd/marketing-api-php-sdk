...
/**
 * BrandValueStruct Class Doc Comment
 *
 * @category Class
 * @description 品牌形象结构
 * @package  TencentAds
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class BrandValueStruct implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'brand_value_struct';
    ...
    protected static $swaggerTypes = [
        'brandImg' => '\TencentAds\Model\ImageStruct',
        'brandName' => 'string'
    ];
    ...
    {
        return $this->container['brandImg'];
    }

    /**
     * Sets brandImg
     *
     * @param \TencentAds\Model\ImageStruct|mixed $brandImg brandImg
     *
     * @return $this
     */
    public function setBrandImg($brandImg)
    {
        $this->container['brandImg'] = $brandImg;
