...
/**
 * CustomAudienceFilesList Class Doc Comment
 *
 * @category Class
 * @package  TencentAds
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CustomAudienceFilesList implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CustomAudienceFilesList';
    ...
    protected static $swaggerTypes = [
        ...
        'message' => 'string',
        'messageCn' => 'string',
        'data' => '\TencentAds\Model\CustomAudienceFilesListData'
    ];
     ...
     * Sets data
     *
     * @param \TencentAds\Model\CustomAudienceFilesListData $data data
     *
     * @return $this
     */
