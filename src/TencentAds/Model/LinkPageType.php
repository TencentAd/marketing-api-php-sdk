...
class LinkPageType
{
    ...
    const WECHAT_APPOINTMENT_CARD = 'LINK_PAGE_TYPE_WECHAT_APPOINTMENT_CARD';
    const WECHAT_CONSULT = 'LINK_PAGE_TYPE_WECHAT_CONSULT';
    const WECOM_CONSULT = 'LINK_PAGE_TYPE_WECOM_CONSULT';
