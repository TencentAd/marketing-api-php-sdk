...
/**
 * ProductsSystemStatusList Class Doc Comment
 *
 * @category Class
 * @package  TencentAds
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ProductsSystemStatusList implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ProductsSystemStatusList';
    ...
    protected static $swaggerTypes = [
        ...
        'message' => 'string',
        'messageCn' => 'string',
        'data' => '\TencentAds\Model\ProductsSystemStatusListData'
    ];
     ...
     * Sets data
     *
     * @param \TencentAds\Model\ProductsSystemStatusListData $data data
     *
     * @return $this
     */
