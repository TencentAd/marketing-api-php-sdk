...
/**
 * UnpublishAppId Class Doc Comment
 *
 * @category Class
 * @description 未发布版本落地页 App信息
 * @package  TencentAds
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class UnpublishAppId implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'unpublish_app_id';
