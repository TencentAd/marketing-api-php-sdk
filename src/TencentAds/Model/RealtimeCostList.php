...
/**
 * RealtimeCostList Class Doc Comment
 *
 * @category Class
 * @package  TencentAds
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class RealtimeCostList implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'RealtimeCostList';
    ...
    protected static $swaggerTypes = [
        ...
        'message' => 'string',
        'messageCn' => 'string',
        'data' => '\TencentAds\Model\RealtimeCostListData'
    ];
     ...
     * Sets data
     *
     * @param \TencentAds\Model\RealtimeCostListData $data data
     *
     * @return $this
     */
