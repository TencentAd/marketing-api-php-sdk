...
/**
 * CustomFeaturesList Class Doc Comment
 *
 * @category Class
 * @package  TencentAds
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CustomFeaturesList implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CustomFeaturesList';
    ...
    protected static $swaggerTypes = [
        ...
        'message' => 'string',
        'messageCn' => 'string',
        'data' => '\TencentAds\Model\CustomFeaturesListData'
    ];
     ...
     * Sets data
     *
     * @param \TencentAds\Model\CustomFeaturesListData $data data
     *
     * @return $this
     */
