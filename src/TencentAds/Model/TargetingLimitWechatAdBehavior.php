<?php
/**
 * TargetingLimitWechatAdBehavior
 *
 * PHP version 5
 *
 * @category Class
...
/**
 * TargetingLimitWechatAdBehavior Class Doc Comment
 *
 * @category Class
 * @description 微信广告行为定向
 * @package  TencentAds
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class TargetingLimitWechatAdBehavior implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'targeting_limit_wechat_ad_behavior';
    ...
    {
        return $this->container['excludedActions'];
    }
