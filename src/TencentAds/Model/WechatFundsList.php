...
/**
 * WechatFundsList Class Doc Comment
 *
 * @category Class
 * @package  TencentAds
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class WechatFundsList implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'WechatFundsList';
    ...
    protected static $swaggerTypes = [
        ...
        'message' => 'string',
        'messageCn' => 'string',
        'data' => '\TencentAds\Model\WechatFundsListData'
    ];
     ...
     * Sets data
     *
     * @param \TencentAds\Model\WechatFundsListData $data data
     *
     * @return $this
     */
