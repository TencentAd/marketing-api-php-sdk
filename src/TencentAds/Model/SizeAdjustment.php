...
/**
 * SizeAdjustment Class Doc Comment
 *
 * @category Class
 * @description 调整尺寸
 * @package  TencentAds
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class SizeAdjustment implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'size_adjustment';
    ...
    {
        return $this->container['sizeAdjustmentMethod'];
    }
     ...
     * @return $this
     */
    public function setSizeAdjustmentMethod($sizeAdjustmentMethod)
    {
        $this->container['sizeAdjustmentMethod'] = $sizeAdjustmentMethod;
