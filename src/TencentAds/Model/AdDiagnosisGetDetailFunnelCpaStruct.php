<?php
/**
 * AdDiagnosisGetDetailFunnelCpaStruct
 *
 * PHP version 5
 *
 * @category Class
...
/**
 * AdDiagnosisGetDetailFunnelCpaStruct Class Doc Comment
 *
 * @category Class
 * @description 漏斗数据结构体
 * @package  TencentAds
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class AdDiagnosisGetDetailFunnelCpaStruct implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ad_diagnosis_get_detail_funnel_cpa_struct';
