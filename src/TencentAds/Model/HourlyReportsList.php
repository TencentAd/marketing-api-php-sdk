...
/**
 * HourlyReportsList Class Doc Comment
 *
 * @category Class
 * @package  TencentAds
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class HourlyReportsList implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'HourlyReportsList';
    ...
    protected static $swaggerTypes = [
        ...
        'message' => 'string',
        'messageCn' => 'string',
        'data' => '\TencentAds\Model\HourlyReportsListData'
    ];
     ...
     * Sets data
     *
     * @param \TencentAds\Model\HourlyReportsListData $data data
     *
     * @return $this
     */
