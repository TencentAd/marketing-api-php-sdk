...
/**
 * WxSearchBrandAreaDocAccountInfoListButton Class Doc Comment
 *
 * @category Class
 * @description 微信搜一搜品牌专区-账号信息区块数据-list-button
 * @package  TencentAds
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class WxSearchBrandAreaDocAccountInfoListButton implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'wx_search_brand_area_doc_account_info_list_button';
