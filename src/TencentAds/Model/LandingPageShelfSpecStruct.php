...
/**
 * LandingPageShelfSpecStruct Class Doc Comment
 *
 * @category Class
 * @description 图文复合组件
 * @package  TencentAds
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class LandingPageShelfSpecStruct implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'landing_page_shelf_spec_struct';
    ...
    protected static $swaggerTypes = [
        'shelfButtonSpec' => '\TencentAds\Model\LandingPageShelfButtonSpec',
        'imageIdList' => 'string',
        'title' => 'string',
        'desc' => 'string'
    ];
     ...
     *
     * @return \TencentAds\Model\LandingPageShelfButtonSpec
     */
     ...
     *
     * @param \TencentAds\Model\LandingPageShelfButtonSpec $shelfButtonSpec shelfButtonSpec
     *
     * @return $this
     */
