<?php
/**
 * AdDiagnosisGetLabelContributionListItem
 *
 * PHP version 5
 *
 * @category Class
...
/**
 * AdDiagnosisGetLabelContributionListItem Class Doc Comment
 *
 * @category Class
 * @description 定向标签（曝光）贡献度节点
 * @package  TencentAds
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class AdDiagnosisGetLabelContributionListItem implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ad_diagnosis_get_label_contribution_list_item';
