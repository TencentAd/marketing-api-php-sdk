...
/**
 * WechatChannelsTrackingSpec Class Doc Comment
 *
 * @category Class
 * @description 视频号创意层级归因信息
 * @package  TencentAds
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class WechatChannelsTrackingSpec implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'wechat_channels_tracking_spec';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['subProductId'] = isset($data['subProductId']) ? $data['subProductId'] : null;
    }
    ...
    {
        return $this->container['subProductId'];
    }

    /**
     * Sets subProductId
     *
     * @param string|mixed $subProductId subProductId
     *
     * @return $this
     */
    public function setSubProductId($subProductId)
    {
        $this->container['subProductId'] = $subProductId;
