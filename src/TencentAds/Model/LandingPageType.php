...
class LandingPageType
{
    ...
    const LANDING_PAGE_TYPE_WECHAT_QUERY_PAGE = 'LANDING_PAGE_TYPE_WECHAT_QUERY_PAGE';
    ...
    const LANDING_PAGE_TYPE_APP_HARMONY = 'LANDING_PAGE_TYPE_APP_HARMONY';
    const LANDING_PAGE_TYPE_WECHAT_SHOP = 'LANDING_PAGE_TYPE_WECHAT_SHOP';
    ...
    public static function getAllowableEnumValues()
    {
        return [
            ...
            self::LANDING_PAGE_TYPE_WECHAT_QUERY_PAGE,
            self::DEEP_LINK,
            self::H5,
            self::MINI_PROGRAM,
            self::UNIVERSAL_LINK,
            ...
            self::LANDING_PAGE_TYPE_APP_HARMONY,
            self::LANDING_PAGE_TYPE_WECHAT_SHOP,
            self::_DEFAULT,
            self::DEEP_LINK_IOS,
