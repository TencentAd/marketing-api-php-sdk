...
/**
 * TargetingWechatAdBehavior Class Doc Comment
 *
 * @category Class
 * @description 微信再营销，原微信广告行为定向升级为微信再营销
 * @package  TencentAds
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class TargetingWechatAdBehavior implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'targeting_wechat_ad_behavior';
