...
/**
 * TargetingTagsList Class Doc Comment
 *
 * @category Class
 * @package  TencentAds
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class TargetingTagsList implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'TargetingTagsList';
    ...
    protected static $swaggerTypes = [
        ...
        'message' => 'string',
        'messageCn' => 'string',
        'data' => '\TencentAds\Model\TargetingTagsListData'
    ];
     ...
     * Sets data
     *
     * @param \TencentAds\Model\TargetingTagsListData $data data
     *
     * @return $this
     */
