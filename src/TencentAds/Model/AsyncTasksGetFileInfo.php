...
/**
 * AsyncTasksGetFileInfo Class Doc Comment
 *
 * @category Class
 * @description 文件返回结果
 * @package  TencentAds
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class AsyncTasksGetFileInfo implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'async_tasks_get_file_info';
