...
/**
 * BidwordLandingPage Class Doc Comment
 *
 * @category Class
 * @description 关键词落地页信息
 * @package  TencentAds
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class BidwordLandingPage implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'bidword_landing_page';
    ...
    protected static $swaggerTypes = [
        'landingPageList' => '\TencentAds\Model\V3\BackupsJumpinfoStruct[]'
    ];
     ...
     *
     * @param \TencentAds\Model\V3\BackupsJumpinfoStruct[]|mixed $landingPageList landingPageList
     *
     * @return $this
     */
