...
/**
 * SmartDeliveryGoalGameAppActivateRoiSpec Class Doc Comment
 *
 * @category Class
 * @description 游戏应用智投投放目标：激活和首日付费ROI
 * @package  TencentAds
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class SmartDeliveryGoalGameAppActivateRoiSpec implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'smart_delivery_goal_game_app_activate_roi_spec';
