...
/**
 * CommentListGetResponseData Class Doc Comment
 *
 * @category Class
 * @package  TencentAds
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CommentListGetResponseData implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CommentListGetResponseData';
    ...
    protected static $swaggerTypes = [
        'list' => '\TencentAds\Model\V3\CommentListGetListStruct[]',
        'lastBuffer' => 'string',
        'continueFlag' => 'int'
    ];
     ...
     * Gets list
     *
     * @return \TencentAds\Model\V3\CommentListGetListStruct[]|mixed
     */
     ...
     * Sets list
     *
     * @param \TencentAds\Model\V3\CommentListGetListStruct[]|mixed $list list
     *
     * @return $this
     */
    ...
    {
        return $this->container['lastBuffer'];
    }

    /**
     * Sets lastBuffer
     *
     * @param string|mixed $lastBuffer lastBuffer
     *
     * @return $this
     */
