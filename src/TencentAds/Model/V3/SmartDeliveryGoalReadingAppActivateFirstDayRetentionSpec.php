...
/**
 * SmartDeliveryGoalReadingAppActivateFirstDayRetentionSpec Class Doc Comment
 *
 * @category Class
 * @description 阅读应用智投投放目标：激活和次留
 * @package  TencentAds
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class SmartDeliveryGoalReadingAppActivateFirstDayRetentionSpec implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'smart_delivery_goal_reading_app_activate_first_day_retention_spec';
