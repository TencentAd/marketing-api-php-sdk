...
/**
 * SmartDeliveryGoalBidAmountDeepConversionBehaviorBidSpec Class Doc Comment
 *
 * @category Class
 * @description 浅层出价+深层出价
 * @package  TencentAds
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class SmartDeliveryGoalBidAmountDeepConversionBehaviorBidSpec implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'smart_delivery_goal_bid_amount_deep_conversion_behavior_bid_spec';
