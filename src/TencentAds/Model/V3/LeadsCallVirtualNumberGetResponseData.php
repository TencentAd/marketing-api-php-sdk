...
/**
 * LeadsCallVirtualNumberGetResponseData Class Doc Comment
 *
 * @category Class
 * @package  TencentAds
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class LeadsCallVirtualNumberGetResponseData implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'LeadsCallVirtualNumberGetResponseData';
    ...
    {
        return $this->container['virtualNumber'];
    }

    /**
     * Sets virtualNumber
     *
     * @param string|mixed $virtualNumber virtualNumber
     *
     * @return $this
     */
    public function setVirtualNumber($virtualNumber)
    {
        $this->container['virtualNumber'] = $virtualNumber;
