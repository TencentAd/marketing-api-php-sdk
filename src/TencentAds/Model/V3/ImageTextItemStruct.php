...
/**
 * ImageTextItemStruct Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ImageTextItemStruct implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'image_text_item_struct';
    ...
    protected static $swaggerTypes = [
        ...
        'descColor' => 'string',
        'bgColor' => 'string',
        'jumpMode' => '\TencentAds\Model\V3\CanvasImageTextJumpMode',
        'materialId' => 'string',
        'title' => 'string',
        'desc' => 'string',
        'subElemType' => '\TencentAds\Model\V3\CanvasImageTextElementType',
    ...
    protected static $setters = [
        ...
        'bgColor' => 'setBgColor',
        'jumpMode' => 'setJumpMode',
        'materialId' => 'setMaterialId',
        'title' => 'setTitle',
        'desc' => 'setDesc',
        'subElemType' => 'setSubElemType',
        'ghSpec' => 'setGhSpec',
    ...
    protected static $getters = [
        ...
        'bgColor' => 'getBgColor',
        'jumpMode' => 'getJumpMode',
        'materialId' => 'getMaterialId',
        'title' => 'getTitle',
        'desc' => 'getDesc',
        'subElemType' => 'getSubElemType',
        'ghSpec' => 'getGhSpec',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['jumpMode'] = isset($data['jumpMode']) ? $data['jumpMode'] : null;
        $this->container['materialId'] = isset($data['materialId']) ? $data['materialId'] : null;
        $this->container['title'] = isset($data['title']) ? $data['title'] : null;
        $this->container['desc'] = isset($data['desc']) ? $data['desc'] : null;
        $this->container['subElemType'] = isset($data['subElemType']) ? $data['subElemType'] : null;
     ...
     * Sets borderColor
     *
     * @param string|mixed $borderColor borderColor
     *
     * @return $this
     */
     ...
     * Gets jumpMode
     *
     * @return \TencentAds\Model\V3\CanvasImageTextJumpMode|mixed
     */
    public function getJumpMode()
    {
        return $this->container['jumpMode'];
    }

    /**
     * Sets jumpMode
     *
     * @param \TencentAds\Model\V3\CanvasImageTextJumpMode|mixed $jumpMode jumpMode
     *
     * @return $this
     */
    public function setJumpMode($jumpMode)
    {
        $this->container['jumpMode'] = $jumpMode;
     ...
     * Gets subElemType
     *
     * @return \TencentAds\Model\V3\CanvasImageTextElementType|mixed
     */
    public function getSubElemType()
    {
        return $this->container['subElemType'];
    }

    /**
     * Sets subElemType
     *
     * @param \TencentAds\Model\V3\CanvasImageTextElementType|mixed $subElemType subElemType
     *
     * @return $this
     */
    public function setSubElemType($subElemType)
    {
        $this->container['subElemType'] = $subElemType;
