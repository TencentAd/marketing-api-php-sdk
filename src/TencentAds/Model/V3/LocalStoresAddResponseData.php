...
class LocalStoresAddResponseData implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'poiList' => 'string[]',
        'list' => '\TencentAds\Model\V3\LocalStoresAddListStruct[]'
    ];
     ...
     * Gets list
     *
     * @return \TencentAds\Model\V3\LocalStoresAddListStruct[]|mixed
     */
     ...
     * Sets list
     *
     * @param \TencentAds\Model\V3\LocalStoresAddListStruct[]|mixed $list list
     *
     * @return $this
     */
