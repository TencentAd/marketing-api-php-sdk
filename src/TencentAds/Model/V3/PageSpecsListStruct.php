...
/**
 * PageSpecsListStruct Class Doc Comment
 *
 * @category Class
 * @description 页面元素配置
 * @package  TencentAds
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class PageSpecsListStruct implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'page_specs_list_struct';
    ...
    protected static $swaggerTypes = [
        'bgColor' => 'string',
        'pageElementsSpecList' => '\TencentAds\Model\V3\PageElementsSpecListStruct[]'
    ];
     ...
     *
     * @return \TencentAds\Model\V3\PageElementsSpecListStruct[]|mixed
     */
     ...
     *
     * @param \TencentAds\Model\V3\PageElementsSpecListStruct[]|mixed $pageElementsSpecList pageElementsSpecList
     *
     * @return $this
     */
