...
/**
 * HeadImageConfig Class Doc Comment
 *
 * @category Class
 * @description 顶部图片组件配置
 * @package  TencentAds
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class HeadImageConfig implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'head_image_config';
