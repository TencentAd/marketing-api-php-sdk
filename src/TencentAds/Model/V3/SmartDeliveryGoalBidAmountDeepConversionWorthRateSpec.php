...
/**
 * SmartDeliveryGoalBidAmountDeepConversionWorthRateSpec Class Doc Comment
 *
 * @category Class
 * @description 浅层出价+深层 ROI
 * @package  TencentAds
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class SmartDeliveryGoalBidAmountDeepConversionWorthRateSpec implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'smart_delivery_goal_bid_amount_deep_conversion_worth_rate_spec';
