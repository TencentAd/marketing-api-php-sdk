...
/**
 * HeadVideoConfig Class Doc Comment
 *
 * @category Class
 * @description 顶部视频组件配置
 * @package  TencentAds
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class HeadVideoConfig implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'head_video_config';
