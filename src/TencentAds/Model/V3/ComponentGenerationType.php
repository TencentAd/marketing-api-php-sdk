...
class ComponentGenerationType
{
    ...
    const MATERIAL_AUTHORIZED = 'COMPONENT_GENERATION_TYPE_MATERIAL_AUTHORIZED';
    const SYSTEM_OPTIMIZED_RECOMMENDATIONS = 'COMPONENT_GENERATION_TYPE_SYSTEM_OPTIMIZED_RECOMMENDATIONS';
    const MPA = 'COMPONENT_GENERATION_TYPE_MPA';
    const SYSTEM_AUTO_FILL = 'COMPONENT_GENERATION_TYPE_SYSTEM_AUTO_FILL';
    const TONGTOU_SEARCH_DERIVATIVE = 'COMPONENT_GENERATION_TYPE_TONGTOU_SEARCH_DERIVATIVE';
    ...
    public static function getAllowableEnumValues()
    {
        return [
            ...
            self::SYSTEM_OPTIMIZED_RECOMMENDATIONS,
            self::MPA,
            self::SYSTEM_AUTO_FILL,
            self::TONGTOU_SEARCH_DERIVATIVE,
