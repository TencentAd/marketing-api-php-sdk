...
/**
 * SmartDeliveryGoalFirstDayMonetizationSpec Class Doc Comment
 *
 * @category Class
 * @description 首日变现目标信息
 * @package  TencentAds
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class SmartDeliveryGoalFirstDayMonetizationSpec implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'smart_delivery_goal_first_day_monetization_spec';
