...
/**
 * FinderAdObjectListGetListStruct Class Doc Comment
 *
 * @category Class
 * @description 返回结构
 * @package  TencentAds
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class FinderAdObjectListGetListStruct implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'FinderAdObjectListGetListStruct';
     ...
     * Gets finderObject
     *
     * @return \TencentAds\Model\V3\FinderObjectStruct|mixed
     */
    public function getFinderObject()
    {
        return $this->container['finderObject'];
    }

    /**
     * Sets finderObject
     *
     * @param \TencentAds\Model\V3\FinderObjectStruct|mixed $finderObject finderObject
     *
     * @return $this
     */
    public function setFinderObject($finderObject)
    {
        $this->container['finderObject'] = $finderObject;
