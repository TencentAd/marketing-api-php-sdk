...
/**
 * ReportStruct Class Doc Comment
 *
 * @category Class
 * @description 报表指标数据返回结构
 * @package  TencentAds
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ReportStruct implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'report_struct';
