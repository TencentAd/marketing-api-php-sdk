...
class MarketingAssetType
{
    ...
    const TELECOMMUNICATIONS_OPERATOR_FUSION_PRODUCTS = 'MARKETING_ASSET_TYPE_TELECOMMUNICATIONS_OPERATOR_FUSION_PRODUCTS';
    ...
    const FINANCE_BANK_CARD_RIGHTS = 'MARKETING_ASSET_TYPE_FINANCE_BANK_CARD_RIGHTS';
    const FINANCE_INSURANCE = 'MARKETING_ASSET_TYPE_FINANCE_INSURANCE';
    const FINANCE_INSURANCE_BROKER_RECRUITMENT = 'MARKETING_ASSET_TYPE_FINANCE_INSURANCE_BROKER_RECRUITMENT';
    ...
    const TOURIST_CRUISE_LINE_CRUISE_LINE = 'MARKETING_ASSET_TYPE_TOURIST_CRUISE_LINE_CRUISE_LINE';
    ...
    const TOURIST_HOTEL_SERVICE_STARRED_HOTEL = 'MARKETING_ASSET_TYPE_TOURIST_HOTEL_SERVICE_STARRED_HOTEL';
    ...
    const PLATFORM_CHANNEL_APP_ANDROID = 'MARKETING_ASSET_TYPE_PLATFORM_CHANNEL_APP_ANDROID';
    const PLATFORM_CHANNEL_APP_IOS = 'MARKETING_ASSET_TYPE_PLATFORM_CHANNEL_APP_IOS';
    const PLATFORM_CHANNEL_MINI_PROGRAM_WECHAT = 'MARKETING_ASSET_TYPE_PLATFORM_CHANNEL_MINI_PROGRAM_WECHAT';
    const VIDEO_PROGRAM_MAIN = 'MARKETING_ASSET_TYPE_VIDEO_PROGRAM_MAIN';
    const PRODUCT_AGGREGATION_PAGE_CATEGORY = 'MARKETING_ASSET_TYPE_PRODUCT_AGGREGATION_PAGE_CATEGORY';
    const PRODUCT_AGGREGATION_PAGE_CUSTOMIZED_PRODUCT_BUNDLES = 'MARKETING_ASSET_TYPE_PRODUCT_AGGREGATION_PAGE_CUSTOMIZED_PRODUCT_BUNDLES';
    ...
    public static function getAllowableEnumValues()
    {
        return [
            ...
            self::TELECOMMUNICATIONS_OPERATOR_FUSION_PRODUCTS,
            ...
            self::FINANCE_WEALTH,
            self::FINANCE_OTHER,
            self::FINANCE_BANK_CARD_RIGHTS,
            self::FINANCE_INSURANCE,
            self::FINANCE_INSURANCE_BROKER_RECRUITMENT,
            ...
            self::TOURIST_CRUISE_LINE_CRUISE_LINE,
            self::TOURIST_HOTEL_SERVICE_BRAND,
            self::TOURIST_HOTEL_SERVICE_SERVICE,
            self::TOURIST_HOTEL_SERVICE_STARRED_HOTEL,
            self::TOURIST_AIRLINE_TICKETS_AIRLINE,
            self::TOURIST_AIRLINE_TICKETS_TICKETS,
            self::PLATFORM_CHANNEL_APP_ANDROID,
            self::PLATFORM_CHANNEL_APP_IOS,
            self::PLATFORM_CHANNEL_MINI_PROGRAM_WECHAT,
            self::VIDEO_PROGRAM_MAIN,
            self::PRODUCT_AGGREGATION_PAGE_CATEGORY,
            self::PRODUCT_AGGREGATION_PAGE_CUSTOMIZED_PRODUCT_BUNDLES,
        ];
    }
}
