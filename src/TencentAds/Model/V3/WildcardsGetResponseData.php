...
class WildcardsGetResponseData implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'list' => '\TencentAds\Model\V3\WildcardsGetListStruct[]'
    ];
     ...
     * Gets list
     *
     * @return \TencentAds\Model\V3\WildcardsGetListStruct[]|mixed
     */
     ...
     * Sets list
     *
     * @param \TencentAds\Model\V3\WildcardsGetListStruct[]|mixed $list list
     *
     * @return $this
     */
