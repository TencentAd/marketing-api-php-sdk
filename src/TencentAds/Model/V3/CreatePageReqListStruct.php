...
/**
 * CreatePageReqListStruct Class Doc Comment
 *
 * @category Class
 * @description 落地页配置结构
 * @package  TencentAds
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CreatePageReqListStruct implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'create_page_req_list_struct';
    ...
    protected static $swaggerTypes = [
        'pageType' => '\TencentAds\Model\V3\ComponentsPageType',
        'pageName' => 'string',
        'pageTitle' => 'string',
        'clipboard' => 'string',
        'pageDeeplink' => 'string',
        ...
        'bgColor' => 'string',
        'bgImageId' => 'string',
        'componentSpecList' => '\TencentAds\Model\V3\ComponentSpecStruct[]'
    ];
     ...
     * Gets pageType
     *
     * @return \TencentAds\Model\V3\ComponentsPageType|mixed
     */
     ...
     * Sets pageType
     *
     * @param \TencentAds\Model\V3\ComponentsPageType|mixed $pageType pageType
     *
     * @return $this
     */
     ...
     *
     * @return \TencentAds\Model\V3\ComponentSpecStruct[]|mixed
     */
     ...
     *
     * @param \TencentAds\Model\V3\ComponentSpecStruct[]|mixed $componentSpecList componentSpecList
     *
     * @return $this
     */
