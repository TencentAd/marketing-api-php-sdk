...
class EcommerceOrderListStruct implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'ecommerceOrderStatus' => '\TencentAds\Model\V3\EcommerceOrderStatus',
        'userName' => 'string',
        'userPhone' => 'string',
        'userProvince' => 'string',
        'userCity' => 'string',
        ...
        'adgroupName' => 'string',
        'fromAccountId' => 'int',
        'deliverySpec' => '\TencentAds\Model\V3\DeliverySpec'
    ];
     ...
     *
     * @return \TencentAds\Model\V3\EcommerceOrderStatus|mixed
     */
     ...
     *
     * @param \TencentAds\Model\V3\EcommerceOrderStatus|mixed $ecommerceOrderStatus ecommerceOrderStatus
     *
     * @return $this
     */
     ...
     * Gets deliverySpec
     *
     * @return \TencentAds\Model\V3\DeliverySpec|mixed
     */
     ...
     * Sets deliverySpec
     *
     * @param \TencentAds\Model\V3\DeliverySpec|mixed $deliverySpec deliverySpec
     *
     * @return $this
     */
