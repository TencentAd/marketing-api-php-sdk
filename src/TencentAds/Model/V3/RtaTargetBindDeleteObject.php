...
/**
 * RtaTargetBindDeleteObject Class Doc Comment
 *
 * @category Class
 * @description 解除RTA策略绑定信息
 * @package  TencentAds
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class RtaTargetBindDeleteObject implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'rta_target_bind_delete_object';
