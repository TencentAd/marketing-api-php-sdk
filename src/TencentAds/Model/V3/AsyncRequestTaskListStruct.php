...
/**
 * AsyncRequestTaskListStruct Class Doc Comment
 *
 * @category Class
 * @description 返回结构
 * @package  TencentAds
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class AsyncRequestTaskListStruct implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'async_request_task_list_struct';
    ...
    protected static $swaggerTypes = [
        ...
        'taskName' => 'string',
        'taskType' => 'string',
        'taskScope' => '\TencentAds\Model\V3\TaskScope',
        'status' => '\TencentAds\Model\V3\TaskStatus',
        'resultStatus' => '\TencentAds\Model\V3\TaskResultStatus',
        'createdTime' => 'int',
        'endTime' => 'int',
     ...
     * Gets taskScope
     *
     * @return \TencentAds\Model\V3\TaskScope|mixed
     */
     ...
     * Sets taskScope
     *
     * @param \TencentAds\Model\V3\TaskScope|mixed $taskScope taskScope
     *
     * @return $this
     */
     ...
     * Gets status
     *
     * @return \TencentAds\Model\V3\TaskStatus|mixed
     */
     ...
     * Sets status
     *
     * @param \TencentAds\Model\V3\TaskStatus|mixed $status status
     *
     * @return $this
     */
     ...
     * Gets resultStatus
     *
     * @return \TencentAds\Model\V3\TaskResultStatus|mixed
     */
     ...
     * Sets resultStatus
     *
     * @param \TencentAds\Model\V3\TaskResultStatus|mixed $resultStatus resultStatus
     *
     * @return $this
     */
