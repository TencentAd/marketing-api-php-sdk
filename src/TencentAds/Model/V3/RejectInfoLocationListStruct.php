...
/**
 * RejectInfoLocationListStruct Class Doc Comment
 *
 * @category Class
 * @description 拒绝原因位置标注信息
 * @package  TencentAds
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class RejectInfoLocationListStruct implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'reject_info_location_list_struct';
