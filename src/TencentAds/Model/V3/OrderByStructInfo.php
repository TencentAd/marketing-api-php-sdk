...
/**
 * OrderByStructInfo Class Doc Comment
 *
 * @category Class
 * @description 排序字段结构
 * @package  TencentAds
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class OrderByStructInfo implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'order_by_struct_info';
    ...
    protected static $swaggerTypes = [
        'sortField' => 'string',
        'sortType' => '\TencentAds\Model\V3\Sorted'
    ];
     ...
     * Gets sortType
     *
     * @return \TencentAds\Model\V3\Sorted|mixed
     */
     ...
     * Sets sortType
     *
     * @param \TencentAds\Model\V3\Sorted|mixed $sortType sortType
     *
     * @return $this
     */
