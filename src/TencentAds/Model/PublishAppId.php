...
/**
 * PublishAppId Class Doc Comment
 *
 * @category Class
 * @description 已发布版本落地页 App信息
 * @package  TencentAds
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class PublishAppId implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'publish_app_id';
