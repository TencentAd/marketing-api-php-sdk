<?php
/**
 * CustomFeatureClassProjectGrantsCustomFeatureClassProjectGrant
 *
 * PHP version 5
 *
 * @category Class
...
/**
 * CustomFeatureClassProjectGrantsCustomFeatureClassProjectGrant Class Doc Comment
 *
 * @category Class
 * @description custom_feature_class_project_grant返回结构
 * @package  TencentAds
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CustomFeatureClassProjectGrantsCustomFeatureClassProjectGrant implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'custom_feature_class_project_grants_custom_feature_class_project_grant';
