<?php
/**
 * AdDiagnosisGetAcceptanceListItem
 *
 * PHP version 5
 *
 * @category Class
...
/**
 * AdDiagnosisGetAcceptanceListItem Class Doc Comment
 *
 * @category Class
 * @description 用户接受度列表节点
 * @package  TencentAds
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class AdDiagnosisGetAcceptanceListItem implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ad_diagnosis_get_acceptance_list_item';
