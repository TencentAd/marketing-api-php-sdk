...
/**
 * FormListItemData Class Doc Comment
 *
 * @category Class
 * @description 表单列表每一项目
 * @package  TencentAds
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class FormListItemData implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'form_list_item_data';
