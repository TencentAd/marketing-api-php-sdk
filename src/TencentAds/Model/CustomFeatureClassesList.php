...
/**
 * CustomFeatureClassesList Class Doc Comment
 *
 * @category Class
 * @package  TencentAds
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CustomFeatureClassesList implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CustomFeatureClassesList';
    ...
    protected static $swaggerTypes = [
        ...
        'message' => 'string',
        'messageCn' => 'string',
        'data' => '\TencentAds\Model\CustomFeatureClassesListData'
    ];
     ...
     * Sets data
     *
     * @param \TencentAds\Model\CustomFeatureClassesListData $data data
     *
     * @return $this
     */
