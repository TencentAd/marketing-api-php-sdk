...
/**
 * PromotionSublinkComponentValueStruct Class Doc Comment
 *
 * @category Class
 * @description 活动促销组件结构
 * @package  TencentAds
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class PromotionSublinkComponentValueStruct implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'promotion_sublink_component_value_struct';
