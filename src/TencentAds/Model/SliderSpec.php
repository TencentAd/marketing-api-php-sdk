...
/**
 * SliderSpec Class Doc Comment
 *
 * @category Class
 * @description 基础轮播图组件元素&lt;br&gt;        图片尺寸: 普通轮播样式: 750*(300-1125), &lt;br&gt;        卡片轮播样式: 512*(288-920)
 * @package  TencentAds
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class SliderSpec implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'slider_spec';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['sliderStyle'] = isset($data['sliderStyle']) ? $data['sliderStyle'] : null;
    ...
    {
        return $this->container['sliderStyle'];
    }
     ...
     * @return $this
     */
    public function setSliderStyle($sliderStyle)
    {
        $this->container['sliderStyle'] = $sliderStyle;
