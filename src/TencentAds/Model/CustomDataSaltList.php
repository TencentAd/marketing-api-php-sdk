...
/**
 * CustomDataSaltList Class Doc Comment
 *
 * @category Class
 * @package  TencentAds
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CustomDataSaltList implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CustomDataSaltList';
    ...
    protected static $swaggerTypes = [
        ...
        'message' => 'string',
        'messageCn' => 'string',
        'data' => '\TencentAds\Model\CustomDataSaltGetSalt[]'
    ];
     ...
     * Sets data
     *
     * @param \TencentAds\Model\CustomDataSaltGetSalt[] $data data
     *
     * @return $this
     */
