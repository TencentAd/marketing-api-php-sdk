...
/**
 * LingqueSpecStruct Class Doc Comment
 *
 * @category Class
 * @description 灵鹊落地页数据结构
 * @package  TencentAds
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class LingqueSpecStruct implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'lingque_spec_struct';
