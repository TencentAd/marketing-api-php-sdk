...
/**
 * ComplianceValidationList Class Doc Comment
 *
 * @category Class
 * @package  TencentAds
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ComplianceValidationList implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ComplianceValidationList';
    ...
    protected static $swaggerTypes = [
        ...
        'message' => 'string',
        'messageCn' => 'string',
        'data' => '\TencentAds\Model\ComplianceValidationListData'
    ];
     ...
     * Sets data
     *
     * @param \TencentAds\Model\ComplianceValidationListData $data data
     *
     * @return $this
     */
