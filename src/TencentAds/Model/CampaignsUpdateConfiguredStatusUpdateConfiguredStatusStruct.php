...
/**
 * CampaignsUpdateConfiguredStatusUpdateConfiguredStatusStruct Class Doc Comment
 *
 * @category Class
 * @description 更新客户设置的状态条件
 * @package  TencentAds
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CampaignsUpdateConfiguredStatusUpdateConfiguredStatusStruct implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CampaignsUpdateConfiguredStatusUpdateConfiguredStatusStruct';
