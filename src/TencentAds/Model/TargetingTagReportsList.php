...
/**
 * TargetingTagReportsList Class Doc Comment
 *
 * @category Class
 * @package  TencentAds
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class TargetingTagReportsList implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'TargetingTagReportsList';
    ...
    protected static $swaggerTypes = [
        ...
        'message' => 'string',
        'messageCn' => 'string',
        'data' => '\TencentAds\Model\TargetingTagReportsListData'
    ];
     ...
     * Sets data
     *
     * @param \TencentAds\Model\TargetingTagReportsListData $data data
     *
     * @return $this
     */
