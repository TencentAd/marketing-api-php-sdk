...
/**
 * CustomFeaturesAddResponse Class Doc Comment
 *
 * @category Class
 * @package  TencentAds
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CustomFeaturesAddResponse implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CustomFeaturesAddResponse';
    ...
    protected static $swaggerTypes = [
        ...
        'message' => 'string',
        'messageCn' => 'string',
        'data' => '\TencentAds\Model\CustomFeaturesAddResponseData'
    ];
     ...
     * Sets data
     *
     * @param \TencentAds\Model\CustomFeaturesAddResponseData $data data
     *
     * @return $this
     */
