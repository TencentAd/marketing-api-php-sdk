...
/**
 * UserActionSetReportsList Class Doc Comment
 *
 * @category Class
 * @package  TencentAds
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class UserActionSetReportsList implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'UserActionSetReportsList';
    ...
    protected static $swaggerTypes = [
        ...
        'message' => 'string',
        'messageCn' => 'string',
        'data' => '\TencentAds\Model\UserActionSetReportsListData'
    ];
     ...
     * Sets data
     *
     * @param \TencentAds\Model\UserActionSetReportsListData $data data
     *
     * @return $this
     */
