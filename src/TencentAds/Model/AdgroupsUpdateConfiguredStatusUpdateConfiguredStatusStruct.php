...
/**
 * AdgroupsUpdateConfiguredStatusUpdateConfiguredStatusStruct Class Doc Comment
 *
 * @category Class
 * @description 更新单个广告组客户设置的状态条件
 * @package  TencentAds
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class AdgroupsUpdateConfiguredStatusUpdateConfiguredStatusStruct implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'AdgroupsUpdateConfiguredStatusUpdateConfiguredStatusStruct';
