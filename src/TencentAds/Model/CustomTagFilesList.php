...
/**
 * CustomTagFilesList Class Doc Comment
 *
 * @category Class
 * @package  TencentAds
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CustomTagFilesList implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CustomTagFilesList';
    ...
    protected static $swaggerTypes = [
        ...
        'message' => 'string',
        'messageCn' => 'string',
        'data' => '\TencentAds\Model\CustomTagFilesListData'
    ];
     ...
     * Sets data
     *
     * @param \TencentAds\Model\CustomTagFilesListData $data data
     *
     * @return $this
     */
