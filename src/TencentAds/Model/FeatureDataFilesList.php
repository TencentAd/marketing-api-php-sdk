...
/**
 * FeatureDataFilesList Class Doc Comment
 *
 * @category Class
 * @package  TencentAds
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class FeatureDataFilesList implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'FeatureDataFilesList';
    ...
    protected static $swaggerTypes = [
        ...
        'message' => 'string',
        'messageCn' => 'string',
        'data' => '\TencentAds\Model\FeatureDataFilesListData'
    ];
     ...
     * Sets data
     *
     * @param \TencentAds\Model\FeatureDataFilesListData $data data
     *
     * @return $this
     */
