<?php
/**
 * AdDiagnosisGetCpaEffectDataStruct
 *
 * PHP version 5
 *
 * @category Class
...
/**
 * AdDiagnosisGetCpaEffectDataStruct Class Doc Comment
 *
 * @category Class
 * @description cpa效果数据
 * @package  TencentAds
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class AdDiagnosisGetCpaEffectDataStruct implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ad_diagnosis_get_cpa_effect_data_struct';
    ...
    protected static $swaggerTypes = [
        ...
        'realCpa' => 'double',
        'cpaBias' => 'double',
        'industryTopTargetcpa' => 'double',
        'industryAvgTargetcpa' => 'double'
    ];
     ...
     *
     * @param double $conversionCount conversionCount
     *
     * @return $this
     */
     ...
     *
     * @param double $industryTopTargetcpa industryTopTargetcpa
     *
     * @return $this
     */
     ...
     *
     * @param double $industryAvgTargetcpa industryAvgTargetcpa
     *
     * @return $this
     */
