...
/**
 * OrderByReportStruct Class Doc Comment
 *
 * @category Class
 * @description 排序字段结构
 * @package  TencentAds
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class OrderByReportStruct implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'order_by_report_struct';
    ...
    protected static $swaggerTypes = [
        'sortField' => 'string',
        'sortType' => '\TencentAds\Model\Sortord'
    ];
