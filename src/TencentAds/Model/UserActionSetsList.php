...
/**
 * UserActionSetsList Class Doc Comment
 *
 * @category Class
 * @package  TencentAds
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class UserActionSetsList implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'UserActionSetsList';
    ...
    protected static $swaggerTypes = [
        ...
        'message' => 'string',
        'messageCn' => 'string',
        'data' => '\TencentAds\Model\UserActionSetsListData'
    ];
     ...
     * Sets data
     *
     * @param \TencentAds\Model\UserActionSetsListData $data data
     *
     * @return $this
     */
