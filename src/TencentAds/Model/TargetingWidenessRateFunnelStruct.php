...
/**
 * TargetingWidenessRateFunnelStruct Class Doc Comment
 *
 * @category Class
 * @description 定向通过率分析
 * @package  TencentAds
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class TargetingWidenessRateFunnelStruct implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'targeting_wideness_rate_funnel_struct';
     ...
     * Sets rankCategory
     *
     * @param string|mixed $rankCategory rankCategory
     *
     * @return $this
     */
