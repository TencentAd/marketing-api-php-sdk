...
class TaskType
{
    ...
    const TASK_TYPE_UPDATE_ACCOUNT_BIDWORD_PRICE = 'TASK_TYPE_UPDATE_ACCOUNT_BIDWORD_PRICE';
    const TASK_TYPE_UPDATE_ACCOUNT_BIDWORD_MATCH_TYPE = 'TASK_TYPE_UPDATE_ACCOUNT_BIDWORD_MATCH_TYPE';
    const TASK_TYPE_MASSIVE_KEYWORD_RECOMMEND = 'TASK_TYPE_MASSIVE_KEYWORD_RECOMMEND';
    const TASK_TYPE_SUMMARY_REPORT_MOMENTS_DOWNLOAD = 'TASK_TYPE_SUMMARY_REPORT_MOMENTS_DOWNLOAD';
    const TASK_TYPE_SEARCH_DOWNLOAD_ALL = 'TASK_TYPE_SEARCH_DOWNLOAD_ALL';
    const TASK_TYPE_MATERIAL_REPORT_DATA = 'TASK_TYPE_MATERIAL_REPORT_DATA';
    const TASK_TYPE_ADCLEANER_UPDATE_ADGROUP_CONFIGURED_STATUS = 'TASK_TYPE_ADCLEANER_UPDATE_ADGROUP_CONFIGURED_STATUS';
    const TASK_TYPE_ADCLEANER_DELETE_ADGROUP = 'TASK_TYPE_ADCLEANER_DELETE_ADGROUP';
    const TASK_TYPE_SEARCH_ADGROUP_CREATIVE_TYPE_DATA = 'TASK_TYPE_SEARCH_ADGROUP_CREATIVE_TYPE_DATA';
    const TASK_TYPE_INTEGRATED_DATA_V3 = 'TASK_TYPE_INTEGRATED_DATA_V3';
    const TASK_TYPE_CONTRACT_REFUND_DETAIL_DOWNLOAD = 'TASK_TYPE_CONTRACT_REFUND_DETAIL_DOWNLOAD';
    ...
    const TASK_TYPE_TRANSCODE_SIXTY_NINE_TASK = 'TASK_TYPE_TRANSCODE_SIXTY_NINE_TASK';
    ...
    const TASK_TYPE_UPDATE_ADCREATIVE_OBJECT_COMMENT_FLAG = 'TASK_TYPE_UPDATE_ADCREATIVE_OBJECT_COMMENT_FLAG';
    const TASK_TYPE_REPLY_FINDER_OBJECT_COMMENT = 'TASK_TYPE_REPLY_FINDER_OBJECT_COMMENT';
    const TASK_TYPE_AD_BATCH_APPEAL = 'TASK_TYPE_AD_BATCH_APPEAL';
    const TASK_TYPE_UPDATE_DEEP_CONVERSION_BEHAVIOR_ADVANCED_BID = 'TASK_TYPE_UPDATE_DEEP_CONVERSION_BEHAVIOR_ADVANCED_BID';
    const TASK_TYPE_UPDATE_FINDER_OBJECT_COMMENT_FLAG = 'TASK_TYPE_UPDATE_FINDER_OBJECT_COMMENT_FLAG';
    const TASK_TYPE_DELETE_FINDER_OBJECT_COMMENT = 'TASK_TYPE_DELETE_FINDER_OBJECT_COMMENT';
    const TASK_TYPE_UPDATE_UNION_POSITION_PACKAGE_NEW = 'TASK_TYPE_UPDATE_UNION_POSITION_PACKAGE_NEW';
    const TASK_TYPE_UPDATE_EXCLUDE_UNION_POSITION_PACKAGE_NEW = 'TASK_TYPE_UPDATE_EXCLUDE_UNION_POSITION_PACKAGE_NEW';
    const TASK_TYPE_UPDATE_DEEP_CONVERSION_BEHAVIOR_BID_NEW = 'TASK_TYPE_UPDATE_DEEP_CONVERSION_BEHAVIOR_BID_NEW';
    const TASK_TYPE_DELETE_ADGROUP_NEW = 'TASK_TYPE_DELETE_ADGROUP_NEW';
    const TASK_TYPE_UPDATE_ADGROUP_DEEP_CONVERSION_WORTH_RATE_NEW = 'TASK_TYPE_UPDATE_ADGROUP_DEEP_CONVERSION_WORTH_RATE_NEW';
    const TASK_TYPE_TARGETINGS_SHARE_NEW = 'TASK_TYPE_TARGETINGS_SHARE_NEW';
    const TASK_TYPE_UPDATE_ADGROUP_CONFIGURED_STATUS_NEW = 'TASK_TYPE_UPDATE_ADGROUP_CONFIGURED_STATUS_NEW';
    const TASK_TYPE_UPDATE_ADGROUP_DAILY_BUDGET_NEW = 'TASK_TYPE_UPDATE_ADGROUP_DAILY_BUDGET_NEW';
    const TASK_TYPE_UPDATE_ADGROUP_AUTO_ACQUISITION_NEW = 'TASK_TYPE_UPDATE_ADGROUP_AUTO_ACQUISITION_NEW';
    const TASK_TYPE_UPDATE_ADGROUP_DEEP_CONVERSION_WORTH_ADVANCED_RATE_NEW = 'TASK_TYPE_UPDATE_ADGROUP_DEEP_CONVERSION_WORTH_ADVANCED_RATE_NEW';
    const TASK_TYPE_UPDATE_DEEP_CONVERSION_BEHAVIOR_ADVANCED_BID_NEW = 'TASK_TYPE_UPDATE_DEEP_CONVERSION_BEHAVIOR_ADVANCED_BID_NEW';
    const TASK_TYPE_UPDATE_SEARCH_INTELLIGENT_EXTENSION = 'TASK_TYPE_UPDATE_SEARCH_INTELLIGENT_EXTENSION';
    const TASK_TYPE_SYNC_ANDROID_CHANNEL_PACKAGE_DATA = 'TASK_TYPE_SYNC_ANDROID_CHANNEL_PACKAGE_DATA';
    const TASK_TYPE_UPDATE_ADGROUP_TIME_NEW = 'TASK_TYPE_UPDATE_ADGROUP_TIME_NEW';
    const TASK_TYPE_UPDATE_ADGROUP_DATE_NEW = 'TASK_TYPE_UPDATE_ADGROUP_DATE_NEW';
    const TASK_TYPE_UPDATE_ADGROUP_BID_AMOUNT_NEW = 'TASK_TYPE_UPDATE_ADGROUP_BID_AMOUNT_NEW';
    const TASK_TYPE_REPLY_FINDER_OBJECT_COMMENT_NEW = 'TASK_TYPE_REPLY_FINDER_OBJECT_COMMENT_NEW';
    const TASK_TYPE_UPDATE_FINDER_OBJECT_COMMENT_FLAG_NEW = 'TASK_TYPE_UPDATE_FINDER_OBJECT_COMMENT_FLAG_NEW';
    const TASK_TYPE_DELETE_FINDER_OBJECT_COMMENT_NEW = 'TASK_TYPE_DELETE_FINDER_OBJECT_COMMENT_NEW';
    const TASK_TYPE_UPDATE_DYNAMIC_CREATIVE_CONFIGURED_STATUS_NEW = 'TASK_TYPE_UPDATE_DYNAMIC_CREATIVE_CONFIGURED_STATUS_NEW';
    const TASK_TYPE_DELETE_DYNAMIC_CREATIVE_NEW = 'TASK_TYPE_DELETE_DYNAMIC_CREATIVE_NEW';
    const TASK_TYPE_UPDATE_ADGROUP_BIND_RTA_POLICY_NEW = 'TASK_TYPE_UPDATE_ADGROUP_BIND_RTA_POLICY_NEW';
    const TASK_TYPE_UPDATE_ADCREATIVE_OBJECT_COMMENT_FLAG_NEW = 'TASK_TYPE_UPDATE_ADCREATIVE_OBJECT_COMMENT_FLAG_NEW';
    const TASK_TYPE_DELETE_SCHEDULED_TASK_NEW = 'TASK_TYPE_DELETE_SCHEDULED_TASK_NEW';
    const TASK_TYPE_PROCESS_USER_PAGE_OBJECT_NEW = 'TASK_TYPE_PROCESS_USER_PAGE_OBJECT_NEW';
    const TASK_TYPE_CREATE_SCHEDULED_UPDATE_ADGROUP_DAILY_BUDGET_NEW = 'TASK_TYPE_CREATE_SCHEDULED_UPDATE_ADGROUP_DAILY_BUDGET_NEW';
    const TASK_TYPE_UPDATE_ADGROUP_ECOM_PKAM_NEW = 'TASK_TYPE_UPDATE_ADGROUP_ECOM_PKAM_NEW';
    const TASK_TYPE_UPDATE_ADGROUP_DERIVE_CONF_NEW = 'TASK_TYPE_UPDATE_ADGROUP_DERIVE_CONF_NEW';
    const TASK_TYPE_UPDATE_COMPONENT_SHARED = 'TASK_TYPE_UPDATE_COMPONENT_SHARED';
    const TASK_TYPE_UPDATE_ADGROUP_SMART_DELIVERY_GOAL = 'TASK_TYPE_UPDATE_ADGROUP_SMART_DELIVERY_GOAL';
    const TASK_TYPE_DELETE_ACCOUNT_COMPONENT = 'TASK_TYPE_DELETE_ACCOUNT_COMPONENT';
    const TASK_TYPE_DELETE_ORGANIZATION_COMPONENT = 'TASK_TYPE_DELETE_ORGANIZATION_COMPONENT';
    const TASK_TYPE_DELETE_ACCOUNT_IMAGE = 'TASK_TYPE_DELETE_ACCOUNT_IMAGE';
    const TASK_TYPE_DELETE_ORGANIZATION_IMAGE = 'TASK_TYPE_DELETE_ORGANIZATION_IMAGE';
    const TASK_TYPE_DELETE_ACCOUNT_VIDEO = 'TASK_TYPE_DELETE_ACCOUNT_VIDEO';
    const TASK_TYPE_DELETE_ORGANIZATION_VIDEO = 'TASK_TYPE_DELETE_ORGANIZATION_VIDEO';
    const TASK_TYPE_UPDATE_DYNAMIC_CREATIVE_SEARCH_INTELLIGENT_EXTENSION = 'TASK_TYPE_UPDATE_DYNAMIC_CREATIVE_SEARCH_INTELLIGENT_EXTENSION';
    const TASK_TYPE_UNBIND_COMPONENT_OR_SUSPEND_DC = 'TASK_TYPE_UNBIND_COMPONENT_OR_SUSPEND_DC';
    const TASK_TYPE_MPCONTRACT_HOTUPDATE = 'TASK_TYPE_MPCONTRACT_HOTUPDATE';
    const TASK_TYPE_DOWNLOAD_UNBIND_COMPONENT_RESULT_DETAIL = 'TASK_TYPE_DOWNLOAD_UNBIND_COMPONENT_RESULT_DETAIL';
    const TASK_TYPE_DELETE_CREATIVE_ASSET = 'TASK_TYPE_DELETE_CREATIVE_ASSET';
    const TASK_TYPE_REVIEW_ANDROID_CHANNEL_PACKAGE = 'TASK_TYPE_REVIEW_ANDROID_CHANNEL_PACKAGE';
    const TASK_TYPE_BATCH_CREATE_BIDWORD_V3_NEW = 'TASK_TYPE_BATCH_CREATE_BIDWORD_V3_NEW';
    const TASK_TYPE_BATCH_UPDATE_ALL_BIDWORD_V3_NEW = 'TASK_TYPE_BATCH_UPDATE_ALL_BIDWORD_V3_NEW';
    const TASK_TYPE_MPCONTRACT_HOTUPDATE_SUB_TASK = 'TASK_TYPE_MPCONTRACT_HOTUPDATE_SUB_TASK';
    ...
    const TASK_TYPE_CREATIVE_AIGC_EXCITATION = 'TASK_TYPE_CREATIVE_AIGC_EXCITATION';
    const TASK_TYPE_ACCOUNT_ADD_COMPONENT = 'TASK_TYPE_ACCOUNT_ADD_COMPONENT';
    const TASK_TYPE_ACCOUNT_ADD_COMPONENT_SUB_TASK = 'TASK_TYPE_ACCOUNT_ADD_COMPONENT_SUB_TASK';
    const TASK_TYPE_ORGANIZATION_ADD_COMPONENT = 'TASK_TYPE_ORGANIZATION_ADD_COMPONENT';
    const TASK_TYPE_ORGANIZATION_ADD_COMPONENT_SUB_TASK = 'TASK_TYPE_ORGANIZATION_ADD_COMPONENT_SUB_TASK';
    ...
    const TASK_TYPE_SCHEDULED_UPDATE_ADGROUP_DAILY_BUDGET_NEW = 'TASK_TYPE_SCHEDULED_UPDATE_ADGROUP_DAILY_BUDGET_NEW';
    ...
    const TASK_TYPE_UPDATE_ADCREATIVE_OBJECT_COMMENT_FLAG_SUB_TASK = 'TASK_TYPE_UPDATE_ADCREATIVE_OBJECT_COMMENT_FLAG_SUB_TASK';
    const TASK_TYPE_UPDATE_FINDER_OBJECT_COMMENT_FLAG_SUB_TASK = 'TASK_TYPE_UPDATE_FINDER_OBJECT_COMMENT_FLAG_SUB_TASK';
    const TASK_TYPE_AD_BATCH_APPEAL_SUB_TASK = 'TASK_TYPE_AD_BATCH_APPEAL_SUB_TASK';
    const TASK_TYPE_UPDATE_DEEP_CONVERSION_BEHAVIOR_ADVANCED_BID_SUB_TASK = 'TASK_TYPE_UPDATE_DEEP_CONVERSION_BEHAVIOR_ADVANCED_BID_SUB_TASK';
    const TASK_TYPE_REPLY_FINDER_OBJECT_COMMENT_SUB_TASK = 'TASK_TYPE_REPLY_FINDER_OBJECT_COMMENT_SUB_TASK';
    const TASK_TYPE_DELETE_FINDER_OBJECT_COMMENT_SUB_TASK = 'TASK_TYPE_DELETE_FINDER_OBJECT_COMMENT_SUB_TASK';
    const TASK_TYPE_UPDATE_UNION_POSITION_PACKAGE_NEW_SUB_TASK = 'TASK_TYPE_UPDATE_UNION_POSITION_PACKAGE_NEW_SUB_TASK';
    const TASK_TYPE_UPDATE_EXCLUDE_UNION_POSITION_PACKAGE_NEW_SUB_TASK = 'TASK_TYPE_UPDATE_EXCLUDE_UNION_POSITION_PACKAGE_NEW_SUB_TASK';
    const TASK_TYPE_UPDATE_DEEP_CONVERSION_BEHAVIOR_BID_NEW_SUB_TASK = 'TASK_TYPE_UPDATE_DEEP_CONVERSION_BEHAVIOR_BID_NEW_SUB_TASK';
    const TASK_TYPE_DELETE_ADGROUP_NEW_SUB_TASK = 'TASK_TYPE_DELETE_ADGROUP_NEW_SUB_TASK';
    const TASK_TYPE_UPDATE_ADGROUP_DEEP_CONVERSION_WORTH_RATE_NEW_SUB_TASK = 'TASK_TYPE_UPDATE_ADGROUP_DEEP_CONVERSION_WORTH_RATE_NEW_SUB_TASK';
    const TASK_TYPE_TARGETINGS_SHARE_NEW_SUB_TASK = 'TASK_TYPE_TARGETINGS_SHARE_NEW_SUB_TASK';
    const TASK_TYPE_UPDATE_ADGROUP_CONFIGURED_STATUS_NEW_SUB_TASK = 'TASK_TYPE_UPDATE_ADGROUP_CONFIGURED_STATUS_NEW_SUB_TASK';
    const TASK_TYPE_UPDATE_ADGROUP_DAILY_BUDGET_NEW_SUB_TASK = 'TASK_TYPE_UPDATE_ADGROUP_DAILY_BUDGET_NEW_SUB_TASK';
    const TASK_TYPE_UPDATE_ADGROUP_AUTO_ACQUISITION_NEW_SUB_TASK = 'TASK_TYPE_UPDATE_ADGROUP_AUTO_ACQUISITION_NEW_SUB_TASK';
    const TASK_TYPE_UPDATE_ADGROUP_DEEP_CONVERSION_WORTH_ADVANCED_RATE_NEW_SUB_TASK = 'TASK_TYPE_UPDATE_ADGROUP_DEEP_CONVERSION_WORTH_ADVANCED_RATE_NEW_SUB_TASK';
    const TASK_TYPE_UPDATE_DEEP_CONVERSION_BEHAVIOR_ADVANCED_BID_NEW_SUB_TASK = 'TASK_TYPE_UPDATE_DEEP_CONVERSION_BEHAVIOR_ADVANCED_BID_NEW_SUB_TASK';
    const TASK_TYPE_UPDATE_SEARCH_INTELLIGENT_EXTENSION_SUB_TASK = 'TASK_TYPE_UPDATE_SEARCH_INTELLIGENT_EXTENSION_SUB_TASK';
    const TASK_TYPE_UPDATE_ADGROUP_TIME_NEW_SUB_TASK = 'TASK_TYPE_UPDATE_ADGROUP_TIME_NEW_SUB_TASK';
    const TASK_TYPE_UPDATE_ADGROUP_DATE_NEW_SUB_TASK = 'TASK_TYPE_UPDATE_ADGROUP_DATE_NEW_SUB_TASK';
    const TASK_TYPE_UPDATE_ADGROUP_BID_AMOUNT_NEW_SUB_TASK = 'TASK_TYPE_UPDATE_ADGROUP_BID_AMOUNT_NEW_SUB_TASK';
    const TASK_TYPE_UPDATE_ADGROUP_BIND_RTA_POLICY_NEW_SUB_TASK = 'TASK_TYPE_UPDATE_ADGROUP_BIND_RTA_POLICY_NEW_SUB_TASK';
    const TASK_TYPE_UPDATE_FINDER_OBJECT_COMMENT_FLAG_NEW_SUB_TASK = 'TASK_TYPE_UPDATE_FINDER_OBJECT_COMMENT_FLAG_NEW_SUB_TASK';
    const TASK_TYPE_REPLY_FINDER_OBJECT_COMMENT_NEW_SUB_TASK = 'TASK_TYPE_REPLY_FINDER_OBJECT_COMMENT_NEW_SUB_TASK';
    const TASK_TYPE_DELETE_FINDER_OBJECT_COMMENT_NEW_SUB_TASK = 'TASK_TYPE_DELETE_FINDER_OBJECT_COMMENT_NEW_SUB_TASK';
    const TASK_TYPE_UPDATE_ADCREATIVE_OBJECT_COMMENT_FLAG_NEW_SUB_TASK = 'TASK_TYPE_UPDATE_ADCREATIVE_OBJECT_COMMENT_FLAG_NEW_SUB_TASK';
    const TASK_TYPE_UPDATE_DYNAMIC_CREATIVE_CONFIGURED_STATUS_NEW_SUB_TASK = 'TASK_TYPE_UPDATE_DYNAMIC_CREATIVE_CONFIGURED_STATUS_NEW_SUB_TASK';
    const TASK_TYPE_DELETE_DYNAMIC_CREATIVE_NEW_SUB_TASK = 'TASK_TYPE_DELETE_DYNAMIC_CREATIVE_NEW_SUB_TASK';
    const TASK_TYPE_PROCESS_USER_PAGE_OBJECT_NEW_SUB_TASK = 'TASK_TYPE_PROCESS_USER_PAGE_OBJECT_NEW_SUB_TASK';
    const TASK_TYPE_CREATE_SCHEDULED_UPDATE_ADGROUP_DAILY_BUDGET_NEW_SUB_TASK = 'TASK_TYPE_CREATE_SCHEDULED_UPDATE_ADGROUP_DAILY_BUDGET_NEW_SUB_TASK';
    const TASK_TYPE_DELETE_SCHEDULED_TASK_NEW_SUB_TASK = 'TASK_TYPE_DELETE_SCHEDULED_TASK_NEW_SUB_TASK';
    const TASK_TYPE_UPDATE_ADGROUP_ECOM_PKAM_NEW_SUB_TASK = 'TASK_TYPE_UPDATE_ADGROUP_ECOM_PKAM_NEW_SUB_TASK';
    const TASK_TYPE_UPDATE_ADGROUP_DERIVE_CONF_NEW_SUB_TASK = 'TASK_TYPE_UPDATE_ADGROUP_DERIVE_CONF_NEW_SUB_TASK';
    const TASK_TYPE_UPDATE_COMPONENT_SHARED_SUB_TASK = 'TASK_TYPE_UPDATE_COMPONENT_SHARED_SUB_TASK';
    const TASK_TYPE_UPDATE_ADGROUP_SMART_DELIVERY_GOAL_SUB_TASK = 'TASK_TYPE_UPDATE_ADGROUP_SMART_DELIVERY_GOAL_SUB_TASK';
    const TASK_TYPE_DELETE_ACCOUNT_COMPONENT_SUB_TASK = 'TASK_TYPE_DELETE_ACCOUNT_COMPONENT_SUB_TASK';
    const TASK_TYPE_DELETE_ORGANIZATION_COMPONENT_SUB_TASK = 'TASK_TYPE_DELETE_ORGANIZATION_COMPONENT_SUB_TASK';
    const TASK_TYPE_DELETE_ACCOUNT_IMAGE_SUB_TASK = 'TASK_TYPE_DELETE_ACCOUNT_IMAGE_SUB_TASK';
    const TASK_TYPE_DELETE_ORGANIZATION_IMAGE_SUB_TASK = 'TASK_TYPE_DELETE_ORGANIZATION_IMAGE_SUB_TASK';
    const TASK_TYPE_DELETE_ACCOUNT_VIDEO_SUB_TASK = 'TASK_TYPE_DELETE_ACCOUNT_VIDEO_SUB_TASK';
    const TASK_TYPE_DELETE_ORGANIZATION_VIDEO_SUB_TASK = 'TASK_TYPE_DELETE_ORGANIZATION_VIDEO_SUB_TASK';
    const TASK_TYPE_UPDATE_DYNAMIC_CREATIVE_SEARCH_INTELLIGENT_EXTENSION_SUB_TASK = 'TASK_TYPE_UPDATE_DYNAMIC_CREATIVE_SEARCH_INTELLIGENT_EXTENSION_SUB_TASK';
    const TASK_TYPE_UNBIND_COMPONENT_OR_SUSPEND_DC_SUB_TASK = 'TASK_TYPE_UNBIND_COMPONENT_OR_SUSPEND_DC_SUB_TASK';
    ...
    const TASK_TYPE_DATA_MODEL_CHECKER = 'TASK_TYPE_DATA_MODEL_CHECKER';
    ...
    const TASK_TYPE_UPDATE_LANDING_PAGE_VIDEO_TRANSCODE_STATUS = 'TASK_TYPE_UPDATE_LANDING_PAGE_VIDEO_TRANSCODE_STATUS';
    const TASK_TYPE_CREATE_ASYNC_REPORT = 'TASK_TYPE_CREATE_ASYNC_REPORT';
    const TASK_TYPE_MULTI_ACCOUNT_INTEGRATED_DATA_V3 = 'TASK_TYPE_MULTI_ACCOUNT_INTEGRATED_DATA_V3';
    const TASK_TYPE_CREATE_ASYNC_REPORT_V3 = 'TASK_TYPE_CREATE_ASYNC_REPORT_V3';
    const TASK_TYPE_VIDEO_COMPONENT_TRANSCODE = 'TASK_TYPE_VIDEO_COMPONENT_TRANSCODE';
    const TASK_TYPE_SEARCH_INDUSTRY_TRAFFIC_ANALYSIS_DATA_DOWNLOAD = 'TASK_TYPE_SEARCH_INDUSTRY_TRAFFIC_ANALYSIS_DATA_DOWNLOAD';
    const TASK_TYPE_SEARCH_QUERY_WORD_TRAFFIC_ANALYSIS_DATA_DOWNLOAD = 'TASK_TYPE_SEARCH_QUERY_WORD_TRAFFIC_ANALYSIS_DATA_DOWNLOAD';
    const TASK_TYPE_CREATE_ASYNC_ASSET = 'TASK_TYPE_CREATE_ASYNC_ASSET';
    const TASK_TYPE_UPDATE_ASSET_NAME = 'TASK_TYPE_UPDATE_ASSET_NAME';
    const TASK_TYPE_RISK_CONTROL_STRATEGY_FULL_RECONCILE = 'TASK_TYPE_RISK_CONTROL_STRATEGY_FULL_RECONCILE';
    const TASK_TYPE_UPDATE_ADGROUP_TARGETING = 'TASK_TYPE_UPDATE_ADGROUP_TARGETING';
    const TASK_TYPE_UPDATE_ADGROUP_TARGETING_SUB_TASK = 'TASK_TYPE_UPDATE_ADGROUP_TARGETING_SUB_TASK';
    const TASK_TYPE_REPORT_YICHE_DATA_DOWNLOAD = 'TASK_TYPE_REPORT_YICHE_DATA_DOWNLOAD';
    const TASK_TYPE_INSIGHT_WECHAT_LIVE_DATA_DOWNLOAD = 'TASK_TYPE_INSIGHT_WECHAT_LIVE_DATA_DOWNLOAD';
    const TASK_TYPE_UPDATE_SEARCH_ADCREATIVE_SYS_STATUS = 'TASK_TYPE_UPDATE_SEARCH_ADCREATIVE_SYS_STATUS';
    const TASK_TYPE_BATCH_CREATE_BIDWORD_V3 = 'TASK_TYPE_BATCH_CREATE_BIDWORD_V3';
    const TASK_TYPE_BATCH_UPDATE_ALL_BIDWORD_V3 = 'TASK_TYPE_BATCH_UPDATE_ALL_BIDWORD_V3';
    ...
    public static function getAllowableEnumValues()
    {
        return [
            ...
            self::TASK_TYPE_UPDATE_ACCOUNT_BIDWORD_PRICE,
            self::TASK_TYPE_UPDATE_ACCOUNT_BIDWORD_MATCH_TYPE,
            self::TASK_TYPE_MASSIVE_KEYWORD_RECOMMEND,
            self::TASK_TYPE_SUMMARY_REPORT_MOMENTS_DOWNLOAD,
            self::TASK_TYPE_SEARCH_DOWNLOAD_ALL,
            self::TASK_TYPE_MATERIAL_REPORT_DATA,
            self::TASK_TYPE_ADCLEANER_UPDATE_ADGROUP_CONFIGURED_STATUS,
            self::TASK_TYPE_ADCLEANER_DELETE_ADGROUP,
            self::TASK_TYPE_SEARCH_ADGROUP_CREATIVE_TYPE_DATA,
            self::TASK_TYPE_INTEGRATED_DATA_V3,
            self::TASK_TYPE_CONTRACT_REFUND_DETAIL_DOWNLOAD,
            ...
            self::TASK_TYPE_TRANSCODE_SIXTY_NINE_TASK,
            ...
            self::TASK_TYPE_UPDATE_ADCREATIVE_OBJECT_COMMENT_FLAG,
            self::TASK_TYPE_REPLY_FINDER_OBJECT_COMMENT,
            self::TASK_TYPE_AD_BATCH_APPEAL,
            self::TASK_TYPE_UPDATE_DEEP_CONVERSION_BEHAVIOR_ADVANCED_BID,
            self::TASK_TYPE_UPDATE_FINDER_OBJECT_COMMENT_FLAG,
            self::TASK_TYPE_DELETE_FINDER_OBJECT_COMMENT,
            self::TASK_TYPE_UPDATE_UNION_POSITION_PACKAGE_NEW,
            self::TASK_TYPE_UPDATE_EXCLUDE_UNION_POSITION_PACKAGE_NEW,
            self::TASK_TYPE_UPDATE_DEEP_CONVERSION_BEHAVIOR_BID_NEW,
            self::TASK_TYPE_DELETE_ADGROUP_NEW,
            self::TASK_TYPE_UPDATE_ADGROUP_DEEP_CONVERSION_WORTH_RATE_NEW,
            self::TASK_TYPE_TARGETINGS_SHARE_NEW,
            self::TASK_TYPE_UPDATE_ADGROUP_CONFIGURED_STATUS_NEW,
            self::TASK_TYPE_UPDATE_ADGROUP_DAILY_BUDGET_NEW,
            self::TASK_TYPE_UPDATE_ADGROUP_AUTO_ACQUISITION_NEW,
            self::TASK_TYPE_UPDATE_ADGROUP_DEEP_CONVERSION_WORTH_ADVANCED_RATE_NEW,
            self::TASK_TYPE_UPDATE_DEEP_CONVERSION_BEHAVIOR_ADVANCED_BID_NEW,
            self::TASK_TYPE_UPDATE_SEARCH_INTELLIGENT_EXTENSION,
            self::TASK_TYPE_SYNC_ANDROID_CHANNEL_PACKAGE_DATA,
            self::TASK_TYPE_UPDATE_ADGROUP_TIME_NEW,
            self::TASK_TYPE_UPDATE_ADGROUP_DATE_NEW,
            self::TASK_TYPE_UPDATE_ADGROUP_BID_AMOUNT_NEW,
            self::TASK_TYPE_REPLY_FINDER_OBJECT_COMMENT_NEW,
            self::TASK_TYPE_UPDATE_FINDER_OBJECT_COMMENT_FLAG_NEW,
            self::TASK_TYPE_DELETE_FINDER_OBJECT_COMMENT_NEW,
            self::TASK_TYPE_UPDATE_DYNAMIC_CREATIVE_CONFIGURED_STATUS_NEW,
            self::TASK_TYPE_DELETE_DYNAMIC_CREATIVE_NEW,
            self::TASK_TYPE_UPDATE_ADGROUP_BIND_RTA_POLICY_NEW,
            self::TASK_TYPE_UPDATE_ADCREATIVE_OBJECT_COMMENT_FLAG_NEW,
            self::TASK_TYPE_DELETE_SCHEDULED_TASK_NEW,
            self::TASK_TYPE_PROCESS_USER_PAGE_OBJECT_NEW,
            self::TASK_TYPE_CREATE_SCHEDULED_UPDATE_ADGROUP_DAILY_BUDGET_NEW,
            self::TASK_TYPE_UPDATE_ADGROUP_ECOM_PKAM_NEW,
            self::TASK_TYPE_UPDATE_ADGROUP_DERIVE_CONF_NEW,
            self::TASK_TYPE_UPDATE_COMPONENT_SHARED,
            self::TASK_TYPE_UPDATE_ADGROUP_SMART_DELIVERY_GOAL,
            self::TASK_TYPE_DELETE_ACCOUNT_COMPONENT,
            self::TASK_TYPE_DELETE_ORGANIZATION_COMPONENT,
            self::TASK_TYPE_DELETE_ACCOUNT_IMAGE,
            self::TASK_TYPE_DELETE_ORGANIZATION_IMAGE,
            self::TASK_TYPE_DELETE_ACCOUNT_VIDEO,
            self::TASK_TYPE_DELETE_ORGANIZATION_VIDEO,
            self::TASK_TYPE_UPDATE_DYNAMIC_CREATIVE_SEARCH_INTELLIGENT_EXTENSION,
            self::TASK_TYPE_UNBIND_COMPONENT_OR_SUSPEND_DC,
            self::TASK_TYPE_MPCONTRACT_HOTUPDATE,
            self::TASK_TYPE_DOWNLOAD_UNBIND_COMPONENT_RESULT_DETAIL,
            self::TASK_TYPE_DELETE_CREATIVE_ASSET,
            self::TASK_TYPE_REVIEW_ANDROID_CHANNEL_PACKAGE,
            self::TASK_TYPE_BATCH_CREATE_BIDWORD_V3_NEW,
            self::TASK_TYPE_BATCH_UPDATE_ALL_BIDWORD_V3_NEW,
            self::TASK_TYPE_MPCONTRACT_HOTUPDATE_SUB_TASK,
            ...
            self::TASK_TYPE_CREATIVE_AIGC_EXCITATION,
            self::TASK_TYPE_ACCOUNT_ADD_COMPONENT,
            self::TASK_TYPE_ACCOUNT_ADD_COMPONENT_SUB_TASK,
            self::TASK_TYPE_ORGANIZATION_ADD_COMPONENT,
            self::TASK_TYPE_ORGANIZATION_ADD_COMPONENT_SUB_TASK,
            ...
            self::TASK_TYPE_SCHEDULED_UPDATE_ADGROUP_DAILY_BUDGET_NEW,
            ...
            self::TASK_TYPE_UPDATE_ADCREATIVE_OBJECT_COMMENT_FLAG_SUB_TASK,
            self::TASK_TYPE_UPDATE_FINDER_OBJECT_COMMENT_FLAG_SUB_TASK,
            self::TASK_TYPE_AD_BATCH_APPEAL_SUB_TASK,
            self::TASK_TYPE_UPDATE_DEEP_CONVERSION_BEHAVIOR_ADVANCED_BID_SUB_TASK,
            self::TASK_TYPE_REPLY_FINDER_OBJECT_COMMENT_SUB_TASK,
            self::TASK_TYPE_DELETE_FINDER_OBJECT_COMMENT_SUB_TASK,
            self::TASK_TYPE_UPDATE_UNION_POSITION_PACKAGE_NEW_SUB_TASK,
            self::TASK_TYPE_UPDATE_EXCLUDE_UNION_POSITION_PACKAGE_NEW_SUB_TASK,
            self::TASK_TYPE_UPDATE_DEEP_CONVERSION_BEHAVIOR_BID_NEW_SUB_TASK,
            self::TASK_TYPE_DELETE_ADGROUP_NEW_SUB_TASK,
            self::TASK_TYPE_UPDATE_ADGROUP_DEEP_CONVERSION_WORTH_RATE_NEW_SUB_TASK,
            self::TASK_TYPE_TARGETINGS_SHARE_NEW_SUB_TASK,
            self::TASK_TYPE_UPDATE_ADGROUP_CONFIGURED_STATUS_NEW_SUB_TASK,
            self::TASK_TYPE_UPDATE_ADGROUP_DAILY_BUDGET_NEW_SUB_TASK,
            self::TASK_TYPE_UPDATE_ADGROUP_AUTO_ACQUISITION_NEW_SUB_TASK,
            self::TASK_TYPE_UPDATE_ADGROUP_DEEP_CONVERSION_WORTH_ADVANCED_RATE_NEW_SUB_TASK,
            self::TASK_TYPE_UPDATE_DEEP_CONVERSION_BEHAVIOR_ADVANCED_BID_NEW_SUB_TASK,
            self::TASK_TYPE_UPDATE_SEARCH_INTELLIGENT_EXTENSION_SUB_TASK,
            self::TASK_TYPE_UPDATE_ADGROUP_TIME_NEW_SUB_TASK,
            self::TASK_TYPE_UPDATE_ADGROUP_DATE_NEW_SUB_TASK,
            self::TASK_TYPE_UPDATE_ADGROUP_BID_AMOUNT_NEW_SUB_TASK,
            self::TASK_TYPE_UPDATE_ADGROUP_BIND_RTA_POLICY_NEW_SUB_TASK,
            self::TASK_TYPE_UPDATE_FINDER_OBJECT_COMMENT_FLAG_NEW_SUB_TASK,
            self::TASK_TYPE_REPLY_FINDER_OBJECT_COMMENT_NEW_SUB_TASK,
            self::TASK_TYPE_DELETE_FINDER_OBJECT_COMMENT_NEW_SUB_TASK,
            self::TASK_TYPE_UPDATE_ADCREATIVE_OBJECT_COMMENT_FLAG_NEW_SUB_TASK,
            self::TASK_TYPE_UPDATE_DYNAMIC_CREATIVE_CONFIGURED_STATUS_NEW_SUB_TASK,
            self::TASK_TYPE_DELETE_DYNAMIC_CREATIVE_NEW_SUB_TASK,
            self::TASK_TYPE_PROCESS_USER_PAGE_OBJECT_NEW_SUB_TASK,
            self::TASK_TYPE_CREATE_SCHEDULED_UPDATE_ADGROUP_DAILY_BUDGET_NEW_SUB_TASK,
            self::TASK_TYPE_DELETE_SCHEDULED_TASK_NEW_SUB_TASK,
            self::TASK_TYPE_UPDATE_ADGROUP_ECOM_PKAM_NEW_SUB_TASK,
            self::TASK_TYPE_UPDATE_ADGROUP_DERIVE_CONF_NEW_SUB_TASK,
            self::TASK_TYPE_UPDATE_COMPONENT_SHARED_SUB_TASK,
            self::TASK_TYPE_UPDATE_ADGROUP_SMART_DELIVERY_GOAL_SUB_TASK,
            self::TASK_TYPE_DELETE_ACCOUNT_COMPONENT_SUB_TASK,
            self::TASK_TYPE_DELETE_ORGANIZATION_COMPONENT_SUB_TASK,
            self::TASK_TYPE_DELETE_ACCOUNT_IMAGE_SUB_TASK,
            self::TASK_TYPE_DELETE_ORGANIZATION_IMAGE_SUB_TASK,
            self::TASK_TYPE_DELETE_ACCOUNT_VIDEO_SUB_TASK,
            self::TASK_TYPE_DELETE_ORGANIZATION_VIDEO_SUB_TASK,
            self::TASK_TYPE_UPDATE_DYNAMIC_CREATIVE_SEARCH_INTELLIGENT_EXTENSION_SUB_TASK,
            self::TASK_TYPE_UNBIND_COMPONENT_OR_SUSPEND_DC_SUB_TASK,
            ...
            self::TASK_TYPE_DATA_MODEL_CHECKER,
            self::TASK_TYPE_UPDATE_CREATIVE_WARNSTATUS,
            self::TASK_TYPE_MULTI_ACCOUNT_REPORT_DATA,
            self::TASK_TYPE_UPDATE_LANDING_PAGE_VIDEO_TRANSCODE_STATUS,
            self::TASK_TYPE_CREATE_ASYNC_REPORT,
            self::TASK_TYPE_MULTI_ACCOUNT_INTEGRATED_DATA_V3,
            self::TASK_TYPE_CREATE_ASYNC_REPORT_V3,
            self::TASK_TYPE_VIDEO_COMPONENT_TRANSCODE,
            self::TASK_TYPE_SEARCH_INDUSTRY_TRAFFIC_ANALYSIS_DATA_DOWNLOAD,
            self::TASK_TYPE_SEARCH_QUERY_WORD_TRAFFIC_ANALYSIS_DATA_DOWNLOAD,
            self::TASK_TYPE_CREATE_ASYNC_ASSET,
            self::TASK_TYPE_UPDATE_ASSET_NAME,
            self::TASK_TYPE_RISK_CONTROL_STRATEGY_FULL_RECONCILE,
            self::TASK_TYPE_UPDATE_ADGROUP_TARGETING,
            self::TASK_TYPE_UPDATE_ADGROUP_TARGETING_SUB_TASK,
            self::TASK_TYPE_REPORT_YICHE_DATA_DOWNLOAD,
            self::TASK_TYPE_INSIGHT_WECHAT_LIVE_DATA_DOWNLOAD,
            self::TASK_TYPE_UPDATE_SEARCH_ADCREATIVE_SYS_STATUS,
            self::TASK_TYPE_BATCH_CREATE_BIDWORD_V3,
            self::TASK_TYPE_BATCH_UPDATE_ALL_BIDWORD_V3,
            self::UNKNOWN,
        ];
    }
}
