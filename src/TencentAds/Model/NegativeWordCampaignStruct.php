...
/**
 * NegativeWordCampaignStruct Class Doc Comment
 *
 * @category Class
 * @description 推广计划否定词列表
 * @package  TencentAds
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class NegativeWordCampaignStruct implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'negative_word_campaign_struct';
