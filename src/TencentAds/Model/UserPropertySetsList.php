...
/**
 * UserPropertySetsList Class Doc Comment
 *
 * @category Class
 * @package  TencentAds
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class UserPropertySetsList implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'UserPropertySetsList';
    ...
    protected static $swaggerTypes = [
        ...
        'message' => 'string',
        'messageCn' => 'string',
        'data' => '\TencentAds\Model\UserPropertySetsListData'
    ];
     ...
     * Sets data
     *
     * @param \TencentAds\Model\UserPropertySetsListData $data data
     *
     * @return $this
     */
