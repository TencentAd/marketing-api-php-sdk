...
/**
 * UpdateBidAmountStruct Class Doc Comment
 *
 * @category Class
 * @description 更新单个广告组出价条件
 * @package  TencentAds
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class UpdateBidAmountStruct implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'update_bid_amount_struct';
