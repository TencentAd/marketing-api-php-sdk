<?php
/**
 * AdgroupDeepConversionWorthSpec
 *
 * PHP version 5
 *
 * @category Class
...
/**
 * AdgroupDeepConversionWorthSpec Class Doc Comment
 *
 * @category Class
 * @description oCPA 优化 ROI 配置
 * @package  TencentAds
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class AdgroupDeepConversionWorthSpec implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'adgroup_deep_conversion_worth_spec';
    ...
    protected static $swaggerTypes = [
        'goal' => '\TencentAds\Model\AdgroupDeepConversionWorthGoal',
        'expectedRoi' => 'double'
    ];
     ...
     * Gets goal
     *
     * @return \TencentAds\Model\AdgroupDeepConversionWorthGoal
     */
     ...
     * Sets goal
     *
     * @param \TencentAds\Model\AdgroupDeepConversionWorthGoal $goal goal
     *
     * @return $this
     */
