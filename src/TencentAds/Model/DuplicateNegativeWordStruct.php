...
/**
 * DuplicateNegativeWordStruct Class Doc Comment
 *
 * @category Class
 * @description 否定词重复而导致失败的否定词列表，包括请求的否定词之间重复、请求的否定词和已有否定词重复、否定词和广告组中关键词重复等
 * @package  TencentAds
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class DuplicateNegativeWordStruct implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'duplicate_negative_word_struct';
