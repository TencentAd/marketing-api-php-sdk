...
/**
 * ProductItemsDetailList Class Doc Comment
 *
 * @category Class
 * @package  TencentAds
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ProductItemsDetailList implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ProductItemsDetailList';
    ...
    protected static $swaggerTypes = [
        ...
        'message' => 'string',
        'messageCn' => 'string',
        'data' => '\TencentAds\Model\ProductItemsDetailListData'
    ];
     ...
     * Sets data
     *
     * @param \TencentAds\Model\ProductItemsDetailListData $data data
     *
     * @return $this
     */
